...
/**
 * Always-Left-Strategy implementation
 */
class LeftStrategy extends Strategy{

  Random _rng;
  Position _last;

  LeftStrategy(this._rng){
  }

  /**
   * Calculates and moves to left-direction based on last position
   */
