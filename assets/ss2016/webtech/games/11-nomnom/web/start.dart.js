...
(function() {
  ...
  var dart = [["", "../lib/Model/Items/Block.dart",, M, {
    "^": "",
    Block: {
      "^": "Item;type,id"
    }
  }], ["", "../lib/Controller/Controller.dart",, B, {
    "^": "",
    Controller: {
      "^": "Object;game,view,gameOver,pause,newGame,pacDirection,gameKey,ticker,updater,gameKeyTrigger,mapData,parameters",
      startController$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, bt_pause, map, t1, t2, t3, t4, t5, t6, t7;
        var $async$startController$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                bt_pause = document.querySelector("#pauseButton");
                $async$goto = !$async$self.newGame ? 2 : 4;
                break;
              case 2:
                // then
                $async$goto = 5;
                return P._asyncHelper($async$self.getGame$0(), $async$startController$0, $async$completer);
              case 5:
              ...
              case 3:
                // join
                map = $async$result;
                t1 = $async$self.mapData;
                t2 = $async$self.parameters;
                t3 = H.setRuntimeTypeInfo(new H.JsLinkedHashMap(0, null, null, null, null, null, 0), [null, null]);
                t3 = new L.GameTable(null, null, null, null, null, null, null, null, null, null, null, null, [], [], [], [], [], [], [], [], null, null, t3, 0, false, t1, t2, []);
                t3.DIM = J.$index$asx(t1, "dim");
                t1 = J.$index$asx(t1, "seed");
                t3.SEED = t1;
                t3.pointPoints = J.$index$asx(t2, "pointPoints");
                t3.cherryPoints = J.$index$asx(t2, "cherryPoints");
                t3.orangePoints = J.$index$asx(t2, "orangePoints");
                t3.raspberrySpeed = J.$index$asx(t2, "raspberrySpeed");
                t3.blueBonbonSpeed = J.$index$asx(t2, "blueBonbon");
                t3.redBonbonSpeed = J.$index$asx(t2, "redBonbon");
                t3.speed = J.$index$asx(t2, "speed");
                t3._rng = t1 == null ? C.C__JSRandom : P._Random$(t1);
                t1 = M.NomNom$(t3);
                t3.nomNom = t1;
                t1.points = 0;
                t3.setGameStats$1(map);
                t3.generateGameTable$0();
                $async$self.game = t3;
                t3 = t3.field;
                t1 = P.LinkedHashMap__makeLiteral([0, "nomNomNeutral", 1, "nomNomLeft", 2, "nomNomRight", 3, "nomNomDown", 4, "nomNomUp", 10, "block", 11, "empty", 20, "point", 21, "cherryFruit", 22, "orangeFruit", 30, "raspberryFruit", 31, "lemonFruit", 40, "blueBonbon", 41, "redBonbon", 50, "greenBonbon", 51, "yellowBonbon", 100, "yellowGhost", 101, "greenGhost", 102, "blueGhost", 103, "redGhost", 104, "pinkGhost"]);
                t2 = document.querySelector("#score");
                t4 = document.querySelector("#life");
                t5 = document.querySelector("#level");
                t6 = document.querySelector("#nomNomtable");
                t7 = document.querySelector("#legende");
                t6 = new O.View(t1, t2, t4, t5, t6, t7, document.querySelector("#buttons"), null);
                t6.createGameField$1(t3);
                t6.updateGameField$1(t3);
                J.set$innerHtml$x(t7, '<img id="legende" src="styles/pictures/legende.png"></p>');
                $async$self.view = t6;
                $async$self.ticker = P.Timer_Timer$periodic(C.Duration_10000, new B.Controller_startController_closure($async$self));
                $async$self.updater = P.Timer_Timer$periodic(C.Duration_33000, new B.Controller_startController_closure0($async$self));
                if ($async$self.gameKey.offline === false)
                  $async$self.gameKeyTrigger = P.Timer_Timer$periodic(C.Duration_1000000, new B.Controller_startController_closure1($async$self));
                else
                  ;
                $async$self.view.createGameField$1($async$self.game.field);
                t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [H.getTypeArgumentByIndex(C.EventStreamProvider_keydown, 0)]);
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Controller_startController_closure2($async$self)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = J.get$onClick$x(document.querySelector("#rightButton"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Controller_startController_closure3($async$self)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = J.get$onClick$x(document.querySelector("#leftButton"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Controller_startController_closure4($async$self)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = J.get$onClick$x(document.querySelector("#upButton"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Controller_startController_closure5($async$self)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = J.get$onClick$x(document.querySelector("#downButton"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Controller_startController_closure6($async$self)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = J.get$onClick$x(bt_pause);
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Controller_startController_closure7($async$self, bt_pause)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                // implicit return
        ...
        return P._asyncHelper(null, $async$startController$0, $async$completer, null);
      },
      getGame$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, state, t2, gamestate, $async$temp1;
        var $async$getGame$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$goto = t1.offline === false ? 3 : 4;
                break;
              case 3:
                // then
                P.print("Lets get the game");
                $async$temp1 = J;
                $async$goto = 5;
                return P._asyncHelper(t1.getStates$0(), $async$getGame$0, $async$completer);
              case 5:
                // returning from await.
                ...
                while (true) {
                  if (!t2.moveNext$0()) {
                    ...
                    ;
                  gamestate = t2.get$current();
                  if (J.$eq$(J.$index$asx(gamestate, "userid"), t1.userid)) {
                    state = gamestate;
                    break;
                  } else
                    ;
                ...
                if (state != null) {
                  $async$returnValue = J.$index$asx(state, "state");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
        ...
        return P._asyncHelper(null, $async$getGame$0, $async$completer, null);
      },
      _gameOver$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, t2, t3, t4, t5, $async$temp1;
        var $async$_gameOver$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$self.ticker.cancel$0(0);
                $async$self.updater.cancel$0(0);
                t1 = $async$self.gameKey;
                if (t1.offline === false)
                  $async$self.gameKeyTrigger.cancel$0(0);
                else
                  ;
                t2 = $async$self.view;
                t3 = $async$self.game;
                t4 = t3.field;
                t3 = t3.nomNom;
                t5 = $async$self.gameOver;
                t2.updateGameField$1(t4);
                t2.updateStats$1(t3);
                t3 = t2.game;
                if (t5) {
                  J.set$innerHtml$x(t3, '<p id="gameover">GAME OVER</p>');
                  J.remove$0$ax(t2.level);
                  J.remove$0$ax(t2.life);
                } else
                  J.set$innerHtml$x(t3, '<p id="leveledUp">Congratulation you leveled UP!</p><input id="levelupButton" type="button" value="Next Level">');
                $async$goto = $async$self.gameOver ? 3 : 5;
                break;
              case 3:
                // then
                $async$temp1 = J;
                $async$goto = 6;
                return P._asyncHelper(t1.authenticate$0(), $async$_gameOver$0, $async$completer);
              case 6:
                // returning from await.
                if ($async$temp1.$eq$($async$result, true))
                  $async$self.saveState$0();
                else
                  ;
                // goto return
                $async$goto = 1;
              ...
              case 5:
                // else
                t1 = J.get$onMouseDown$x(document.querySelector("#levelupButton"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.Controller__gameOver_closure($async$self)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
              case 4:
                // join
              case 1:
                // return
        ...
        return P._asyncHelper(null, $async$_gameOver$0, $async$completer, null);
      },
      _onTick$0: function() {
        if (!this.pause) {
          if (this.gameOver) {
      ...
      _triggerGameKey$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this;
        var $async$_triggerGameKey$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = 2;
                return P._asyncHelper($async$self.gameKey.authenticate$0(), $async$_triggerGameKey$0, $async$completer);
              case 2:
                // returning from await.
                if ($async$result === true)
                  J.setInnerHtml$1$x(document.querySelector("#onoff"), "<span>ONLINE</span>");
                else
                  J.setInnerHtml$1$x(document.querySelector("#onoff"), "<span>OFFLINE</span>");
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
              case 1:
                // rethrow
        ...
        return P._asyncHelper(null, $async$_triggerGameKey$0, $async$completer, null);
      },
      _updateView$0: function() {
        var t1 = this.game;
        if (t1.coins <= 0 || t1.gameOver) {
          this.gameOver = t1.gameOver;
          this._gameOver$0();
        } else {
          this.view.updateGameField$1(t1.field);
          this.view.updateStats$1(this.game.nomNom);
        }
      },
      saveState$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, t1, mscore;
        var $async$saveState$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                t1 = $async$self.game.nomNom;
                mscore = P.LinkedHashMap__makeLiteral(["points", t1.points, "level", t1.level, "life", t1.life]);
                t1 = $async$self.gameKey;
                $async$goto = 2;
                return P._asyncHelper(t1.storeState$2(t1.userid, mscore), $async$saveState$0, $async$completer);
              case 2:
                // returning from await.
                if ($async$result === true) {
                  if (!$async$self.gameOver)
                  ...
                  if (!$async$self.gameOver)
                    window.alert("Couldn't save the Game");
                  else
                    ;
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
        ...
        return P._asyncHelper(null, $async$saveState$0, $async$completer, null);
      },
      nextLevel$0: function() {
        ...
        try {
          this.game.generateGameTable$0();
          this.view.createGameField$1(this.game.field);
          this._updateView$0();
          this.ticker = P.Timer_Timer$periodic(C.Duration_10000, new B.Controller_nextLevel_closure(this));
          this.updater = P.Timer_Timer$periodic(C.Duration_33000, new B.Controller_nextLevel_closure0(this));
        } catch (exception) {
          H.unwrapException(exception);
          J.set$innerHtml$x(document.querySelector("#leveledUp"), "Congratulation, you reached the end of the game");
          J.remove$0$ax(document.querySelector("#levelupButton"));
        }
      }
    },
    Controller_startController_closure: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._onTick$0();
      }
    },
    Controller_startController_closure0: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._updateView$0();
      }
    },
    Controller_startController_closure1: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._triggerGameKey$0();
      }
    },
    Controller_startController_closure2: {
      "^": "Closure:17;$this",
      call$1: function(ev) {
        var t1 = this.$this;
        if (t1.gameOver)
        ...
        switch (J.get$keyCode$x(ev)) {
          case 37:
            t1.game.nomNom.desiredDirection = 4;
            break;
          case 39:
            t1.game.nomNom.desiredDirection = 2;
            break;
          case 38:
            t1.game.nomNom.desiredDirection = 1;
            break;
          case 40:
            t1.game.nomNom.desiredDirection = 3;
            break;
        }
      }
    },
    Controller_startController_closure3: {
      "^": "Closure:4;$this",
      call$1: function(mv) {
        var t1 = this.$this;
        if (t1.gameOver)
    ...
    Controller_startController_closure4: {
      "^": "Closure:4;$this",
      call$1: function(mv) {
        var t1 = this.$this;
        if (t1.gameOver)
    ...
    Controller_startController_closure5: {
      "^": "Closure:4;$this",
      call$1: function(mv) {
        var t1 = this.$this;
        if (t1.gameOver)
    ...
    Controller_startController_closure6: {
      "^": "Closure:4;$this",
      call$1: function(mv) {
        var t1 = this.$this;
        if (t1.gameOver)
    ...
    Controller_startController_closure7: {
      "^": "Closure:5;$this,bt_pause",
      call$1: function(ev) {
        var t1, t2;
        t1 = this.$this;
        t2 = this.bt_pause;
        if (!t1.pause) {
          t1.pause = true;
          J.set$value$x(t2, "Start");
          if (t1.gameKey.offline === false) {
            J.insertAdjacentHtml$4$treeSanitizer$validator$x(document.querySelector("#welcome"), "beforeend", '<input id="saveButton" type="button" value="Save">', null, null);
            t2 = J.get$onClick$x(document.querySelector("#saveButton"));
            H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new B.Controller_startController__closure(t1)), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
          }
        } else {
          t1.pause = false;
          J.set$value$x(t2, "Pause");
          if (t1.gameKey.offline === false)
            J.remove$0$ax(document.querySelector("#saveButton"));
        }
      }
    },
    Controller_startController__closure: {
      "^": "Closure:4;$this",
      call$1: function(mv) {
        this.$this.saveState$0();
      }
    },
    Controller__gameOver_closure: {
      "^": "Closure:4;$this",
      call$1: function(ev) {
        this.$this.nextLevel$0();
      }
    },
    Controller_nextLevel_closure: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._onTick$0();
      }
    },
    Controller_nextLevel_closure0: {
      "^": "Closure:0;$this",
      call$1: function(_) {
        return this.$this._updateView$0();
      }
    ...
    DataLoader: {
      ...
      onMapLoad$1: [function(responseText) {
        ...
        P.print("Mapdata loaded");
        this.mapLoaded = true;
        this.checkFinished$0();
      }, "call$1", "get$onMapLoad", 2, 0, 6],
      onGameKeyLoad$1: [function(responseText) {
        this.gamekeyData = C.JsonCodec_null_null.decode$1(responseText);
        P.print("Gamekeydata loaded");
        this.gameKeyLoaded = true;
        this.checkFinished$0();
      }, "call$1", "get$onGameKeyLoad", 2, 0, 6],
      onParameterLoad$1: [function(responseText) {
        this.parameters = C.JsonCodec_null_null.decode$1(responseText);
        P.print("Parameters loaded");
        this.parametersLoaded = true;
        this.checkFinished$0();
      }, "call$1", "get$onParameterLoad", 2, 0, 6],
      checkFinished$0: function() {
        if (this.mapLoaded && this.gameKeyLoaded && this.parametersLoaded)
          this.starter.startGame$0();
      }
    }
  }], ["", "../lib/Model/Strategies/EscapeStrategy.dart",, Q, {
    "^": "",
    EscapeStrategy: {
      "^": "Strategy;",
      move$3: function(currPos, pacmanPos, gt) {
        var possible, distances, t1;
        possible = gt.adjPos$1(currPos);
        distances = [];
        C.JSArray_methods.forEach$1(possible, new Q.EscapeStrategy_move_closure(pacmanPos, distances));
        t1 = C.JSArray_methods.indexOf$1(distances, C.JSArray_methods.firstWhere$1(distances, new Q.EscapeStrategy_move_closure0(C.JSArray_methods.reduce$1(distances, new Q.EscapeStrategy_move_closure1()))));
        if (t1 < 0 || t1 >= possible.length)
          return H.ioore(possible, t1);
        return possible[t1];
      }
    },
    EscapeStrategy_move_closure: {
      "^": "Closure:0;pacmanPos,distances",
      call$1: function(p) {
        ...
        if (typeof t1 !== "number")
          return t1.$sub();
        return this.distances.push((t2 - t4) * (t5 - t4) + (t6 - t3) * (t1 - t3));
      }
    },
    EscapeStrategy_move_closure1: {
      "^": "Closure:3;",
      call$2: function(a, b) {
        return J.$lt$n(a, b) ? b : a;
      }
    },
    EscapeStrategy_move_closure0: {
      "^": "Closure:0;highest",
      call$1: function(a) {
        return J.$eq$(a, this.highest);
      }
    }
  }], ["", "../lib/Model/Strategies/FollowStrategy.dart",, O, {
    "^": "",
    FollowStrategy: {
      "^": "Strategy;",
      move$3: function(currPos, pacmanPos, gt) {
        return this.findPosBfs$3(currPos, pacmanPos, gt);
      },
      findPosBfs$3: function(src, dest, gt) {
        var possible, queue, $parent, visited, found, curr;
        possible = gt.adjPos$1(src);
        if (C.JSArray_methods.contains$1(possible, dest))
          return dest;
        if (J.$eq$(src, dest)) {
          C.JSArray_methods.shuffle$0(possible);
          return C.JSArray_methods.get$first(possible);
        }
        queue = [];
        $parent = H.setRuntimeTypeInfo(new H.JsLinkedHashMap(0, null, null, null, null, null, 0), [null, null]);
        visited = [];
        visited.push(src);
        C.JSArray_methods.forEach$1(possible, new O.FollowStrategy_findPosBfs_closure(src, queue, $parent));
        found = false;
        while (true) {
          if (!(queue.length !== 0 && !found))
            break;
          curr = C.JSArray_methods.removeAt$1(queue, 0);
          if (!J.$eq$(curr, dest)) {
            visited.push(curr);
            C.JSArray_methods.forEach$1(gt.adjPos$1(curr), new O.FollowStrategy_findPosBfs_closure0(queue, $parent, visited, curr));
          } else
            found = true;
        }
        curr = $parent.$index(0, dest);
        for (; !J.$eq$($parent.$index(0, curr), src);)
          curr = $parent.$index(0, curr);
        return curr;
      }
    },
    FollowStrategy_findPosBfs_closure: {
      "^": "Closure:0;src,queue,parent",
      call$1: function(a) {
        this.queue.push(a);
        this.parent.putIfAbsent$2(0, a, new O.FollowStrategy_findPosBfs__closure0(this.src));
      }
    },
    FollowStrategy_findPosBfs__closure0: {
      "^": "Closure:1;src",
      call$0: function() {
        return this.src;
      }
    },
    FollowStrategy_findPosBfs_closure0: {
      "^": "Closure:0;queue,parent,visited,curr",
      call$1: function(p) {
        if (!C.JSArray_methods.contains$1(this.visited, p)) {
          this.queue.push(p);
          this.parent.putIfAbsent$2(0, p, new O.FollowStrategy_findPosBfs__closure(this.curr));
        }
      }
    },
    FollowStrategy_findPosBfs__closure: {
      "^": "Closure:1;curr",
      call$0: function() {
        return this.curr;
      }
    }
  }], ["", "../lib/GameKey/GameKey.dart",, O, {
    "^": "",
    GameKey: {
      "^": "Object;_uri,gameID,gameSecret,username,userpw,userid,usermail,params,_available,offline",
      registerUser$3: function($name, pwd, mail) {
        ...
        var $async$registerUser$3 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t2 = P.Uri_Uri(null, null, null, null, null, null, P.LinkedHashMap__makeLiteral(["name", H.S($name), "pwd", H.S(pwd), "mail", H.S(mail)]), "", "")._query;
                if (t2 == null)
                  t2 = "";
                else
                  ;
                $async$goto = 7;
                return P._asyncHelper(W.HttpRequest_request(t1, "POST", null, null, P.LinkedHashMap__makeLiteral(["content-type", "application/x-www-form-urlencoded", "charset", "UTF-8"]), null, t2, null), $async$registerUser$3, $async$completer);
              case 7:
                // returning from await.
                answer = $async$result;
        ...
        return P._asyncHelper(null, $async$registerUser$3, $async$completer, null);
      },
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$handler = 4;
                t1 = $async$self._uri;
                t2 = "/game/" + H.S($async$self.gameID);
                t1.toString;
                uri = t1.resolveUri$1(P.Uri_parse(t2, 0, null)).resolveUri$1(P.Uri_Uri(null, null, null, null, null, null, P.LinkedHashMap__makeLiteral(["secret", H.S($async$self.gameSecret)]), "", ""));
                $async$goto = 7;
            ...
            switch ($async$goto) {
              ...
              case 7:
                ...
                if (users == null) {
                  ...
                  ;
                user = J.firstWhere$2$orElse$ax(users, new O.GameKey_getUserId_closure($name), null);
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$handler = 4;
                t1 = $async$self._uri;
                t2 = "/gamestate/" + H.S($async$self.gameID);
                t1.toString;
                uri = t1.resolveUri$1(P.Uri_parse(t2, 0, null)).resolveUri$1(P.Uri_Uri(null, null, null, null, null, null, P.LinkedHashMap__makeLiteral(["secret", H.S($async$self.gameSecret)]), "", ""));
                $async$goto = 7;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$handler = 4;
                t1 = $async$self._uri;
                t2 = "/gamestate/" + H.S($async$self.gameID) + "/" + H.S(uid);
                t1.toString;
                t2 = t1.resolveUri$1(P.Uri_parse(t2, 0, null)).toString$0(0);
                t1 = P.Uri_Uri(null, null, null, null, null, null, P.LinkedHashMap__makeLiteral(["secret", H.S($async$self.gameSecret), "state", C.JsonCodec_null_null.encode$1(state)]), "", "")._query;
                if (t1 == null)
                  t1 = "";
                else
                  ;
      ...
      GameKey$4: function(host, port, gameID, gameSecret) {
        var t1;
        this.gameID = gameID;
        ...
        if (J.$eq$(host, "")) {
          ...
          t1 = P.Uri__makeHttpUri("http", H.S(host) + ":" + H.S(port), "/", null);
          this._uri = t1;
        }
        J.toString$0$(t1);
      },
      static: {
        GameKey$: function(host, port, gameID, gameSecret) {
          var t1 = new O.GameKey(null, null, null, null, null, null, null, null, false, null);
          t1.GameKey$4(host, port, gameID, gameSecret);
          return t1;
        }
      }
    },
  ...
  }], ["", "../lib/Model/GameObject.dart",, N, {
    "^": "",
    GameObject: {
      "^": "Object;"
    }
  }], ["", "../lib/Model/GameTable.dart",, L, {
    "^": "",
    GameTable: {
      "^": "Object;DIM,SEED,pointPoints,cherryPoints,orangePoints,raspberrySpeed,blueBonbonSpeed,redBonbonSpeed,speed,tempDelete,_rng,field,fruitList,pillList,ghosts,ghostsList,events,moveablePos,ghostSpawnPositions,itemSpawnPositions,nomNom,levelscale,object,coins,gameOver,mapData,parameters,killedGhosts",
      setGameStats$1: function(map) {
        var t1;
        if (map != null && !J.$eq$(J.$index$asx(map, "level"), 0)) {
          t1 = J.getInterceptor$asx(map);
          this.nomNom.level = t1.$index(map, "level");
          this.nomNom.points = t1.$index(map, "points");
          this.nomNom.life = t1.$index(map, "life");
        }
      },
      onTick$0: function() {
        var t1, t2;
        this.nomNom.onTick$0();
        C.JSArray_methods.forEach$1(this.ghosts, new L.GameTable_onTick_closure());
        t1 = this.events;
        C.JSArray_methods.forEach$1(t1, new L.GameTable_onTick_closure0());
        t2 = this.tempDelete;
        if (t2 != null) {
          C.JSArray_methods.remove$1(t1, t2);
          this.tempDelete = null;
        }
        t1 = this.killedGhosts;
        if (t1.length !== 0) {
          C.JSArray_methods.forEach$1(t1, new L.GameTable_onTick_closure1(this));
          C.JSArray_methods.set$length(t1, 0);
        }
      },
      adjGhostSpeed$2: function(id, speed) {
        var t1 = new A.Event(0, id, null, this);
        t1.tickMax = J.$index$asx(this.parameters, "EventTicks");
        this.events.push(t1);
        C.JSArray_methods.forEach$1(this.ghosts, new L.GameTable_adjGhostSpeed_closure(speed));
      },
      removeEvent$2: function(type, e) {
        var t1;
        if (type === 1) {
          t1 = this.nomNom;
          t1.nomNomTickTemp = t1.nomNomTickMax;
        } else if (type === 2)
          C.JSArray_methods.forEach$1(this.ghosts, new L.GameTable_removeEvent_closure());
        else {
          t1 = this.nomNom;
          t1.eatableGhosts = !t1.eatableGhosts;
        }
        this.tempDelete = e;
      },
      adjPos$1: function(pos) {
        var positions, t1, t2, t3, t4;
        positions = [];
        t1 = this.field;
        t2 = pos.get$X();
        ...
        if (typeof t1 !== "number")
          return t1.$sub();
        t3 = t1 - 1;
        if (!J.$eq$(J.$index$asx(J.$index$asx(t2, t3), 0), 10))
          positions.push(new E.Position(pos.x, t3, null));
        t2 = this.field;
        t3 = pos.x;
        if (t3 >>> 0 !== t3 || t3 >= t2.length)
          return H.ioore(t2, t3);
        t4 = t1 + 1;
        if (!J.$eq$(J.$index$asx(J.$index$asx(t2[t3], t4), 0), 10))
          positions.push(new E.Position(t3, t4, null));
        t2 = this.field;
        t4 = t3 - 1;
        if (t4 < 0 || t4 >= t2.length)
          return H.ioore(t2, t4);
        if (!J.$eq$(J.$index$asx(J.$index$asx(t2[t4], t1), 0), 10))
          positions.push(new E.Position(t4, t1, null));
        t2 = this.field;
        ++t3;
        if (t3 >= t2.length)
          return H.ioore(t2, t3);
        if (!J.$eq$(J.$index$asx(J.$index$asx(t2[t3], t1), 0), 10))
          positions.push(new E.Position(t3, t1, null));
        return positions;
      },
      generateGhosts$1: function(count) {
        var t1, t2, t3, i, t4, t5, g;
        t1 = this.ghosts;
        C.JSArray_methods.set$length(t1, 0);
        t2 = this.ghostsList;
        t2.push(100);
        ...
        for (; i < count; ++i) {
          if (i >= t2.length)
            return H.ioore(t2, i);
          t4 = t2[i];
          t5 = this.getStrategy$1(i);
          g = new G.Ghost(null, 0, null, null, this.getNextGhostSpawnPosition$0(), t5, this, t4);
          g.points = J.$index$asx(this.parameters, "ghostPoints");
          t4 = J.$index$asx(this.parameters, "ghosttickMax");
          g.ghostTickMax = t4;
          g.ghostTickTemp = t4;
          t1.push(g);
          if (i >= t2.length)
            return H.ioore(t2, i);
          t3.$indexSet(0, t2[i], g);
        }
      },
      getStrategy$1: function(strategyNumber) {
        switch (strategyNumber) {
          case 0:
            return new V.RightStrategy(this._rng, null);
          case 1:
            return new F.LeftStrategy(this._rng, null);
          case 2:
            return new O.FollowStrategy();
          case 3:
            return new Q.EscapeStrategy();
        }
        return;
      },
      getNextGhostSpawnPosition$0: function() {
        var t1, t2, t3, ret;
        t1 = this.ghostSpawnPositions;
        t2 = t1.length;
        t3 = this._rng;
        if (t2 !== 0)
          ret = C.JSArray_methods.removeAt$1(t1, t3.nextInt$1(t2));
        else {
          t1 = this.moveablePos;
          t3 = t3.nextInt$1(t1.length);
      ...
      getNextItemSpawnPosition$0: function() {
        var t1, t2, t3, ret;
        t1 = this.itemSpawnPositions;
        t2 = t1.length;
        t3 = this._rng;
        if (t2 !== 0)
          ret = C.JSArray_methods.removeAt$1(t1, t3.nextInt$1(t2));
      ...
      generateGameTable$0: function() {
        var t1, t2, t3, t4, t5, gen, i, j, t6, t7, tmp, pos, _i;
        t1 = this.object;
        t1.clear$0(0);
        t2 = this.moveablePos;
        C.JSArray_methods.set$length(t2, 0);
        t3 = this.ghostSpawnPositions;
        C.JSArray_methods.set$length(t3, 0);
        t4 = this.itemSpawnPositions;
        C.JSArray_methods.set$length(t4, 0);
        this.levelscale = J.$mul$ns(this.nomNom.level, 0.25);
        t5 = this._rng;
        gen = new N.LevelGen(this.DIM, t5, null, this.mapData);
        gen.parseJsonMap$1(this.nomNom.level);
        this.field = P.List_List$generate(this.DIM, new L.GameTable_generateGameTable_closure(this), true, null);
        i = 0;
        while (true) {
          t5 = this.DIM;
          if (typeof t5 !== "number")
          ...
          while (true) {
            ...
            if (typeof t5 !== "number")
              return H.iae(t5);
            tmp = J.$index$asx(t7, C.JSInt_methods.$mod(j, t5));
            t5 = J.getInterceptor(tmp);
            t6 = t5.$eq(tmp, J.$index$asx(J.$index$asx(this.mapData, "defines"), "wall"));
            t7 = this.field;
            if (t6) {
              if (i >= t7.length)
                return H.ioore(t7, i);
              J.$indexSet$ax(J.$index$asx(t7[i], j), 0, 10);
            } else {
              if (i >= t7.length)
                return H.ioore(t7, i);
              J.$indexSet$ax(J.$index$asx(t7[i], j), 0, 20);
              t2.push(new E.Position(i, j, null));
              if (t5.$eq(tmp, J.$index$asx(J.$index$asx(this.mapData, "defines"), "ghosts")))
                t3.push(new E.Position(i, j, null));
              if (t5.$eq(tmp, J.$index$asx(J.$index$asx(this.mapData, "defines"), "items")))
                t4.push(new E.Position(i, j, null));
            }
            t5 = this.field;
            if (i >= t5.length)
              return H.ioore(t5, i);
            J.$indexSet$ax(J.$index$asx(t5[i], j), 1, 11);
            ++j;
          }
          ++i;
        }
        t1.$indexSet(0, 10, new M.Block(null, 10));
        t1.$indexSet(0, 20, new U.PointItem(this.pointPoints, null, 20));
        t1.$indexSet(0, 21, new U.PointItem(this.cherryPoints, null, 21));
        t1.$indexSet(0, 22, new U.PointItem(this.orangePoints, null, 22));
        t1.$indexSet(0, 30, new M.SpeedItem(this.raspberrySpeed, null, 30));
        t1.$indexSet(0, 31, new V.SpecialItem(null, 31));
        t1.$indexSet(0, 40, new M.SpeedItem(this.blueBonbonSpeed, null, 40));
        t1.$indexSet(0, 41, new M.SpeedItem(this.redBonbonSpeed, null, 41));
        t1.$indexSet(0, 50, new V.SpecialItem(null, 50));
        t1.$indexSet(0, 51, new V.SpecialItem(null, 51));
        t1 = this.fruitList;
        t1.push(21);
        t1.push(22);
        t1.push(30);
        ...
        t3.push(50);
        t3.push(51);
        this.levelscale = J.ceil$0$n(this.levelscale);
        i = 0;
        while (true) {
          t4 = this.levelscale;
          if (typeof t4 !== "number")
          ...
          if (!(i < t4))
            break;
          pos = this.getNextItemSpawnPosition$0();
          t4 = this.field;
          t5 = pos.x;
          if (t5 >>> 0 !== t5 || t5 >= t4.length)
            return H.ioore(t4, t5);
          t5 = J.$index$asx(t4[t5], pos.y);
          if (i >= t1.length)
            return H.ioore(t1, i);
          J.$indexSet$ax(t5, 0, t1[i]);
          pos = this.getNextItemSpawnPosition$0();
          t5 = this.field;
          t4 = pos.x;
          if (t4 >>> 0 !== t4 || t4 >= t5.length)
            return H.ioore(t5, t4);
          t4 = J.$index$asx(t5[t4], pos.y);
          if (i >= t3.length)
            return H.ioore(t3, i);
          J.$indexSet$ax(t4, 0, t3[i]);
          ++i;
        }
        this.generateGhosts$1(t4);
        t1 = this.nomNom;
        t3 = this._rng.nextInt$1(t2.length);
        ...
        J.$indexSet$ax(J.$index$asx(t3[t1], t2.y), 1, 2);
        for (t1 = this.field, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          for (t3 = J.get$iterator$ax(t1[_i]); t3.moveNext$0();)
            if (J.$eq$(J.$index$asx(t3.get$current(), 0), 20))
              ++this.coins;
      }
    },
    GameTable_onTick_closure: {
      "^": "Closure:0;",
      call$1: function(ghost) {
        return ghost.onTick$0();
      }
    },
    GameTable_onTick_closure0: {
      "^": "Closure:0;",
      call$1: function($event) {
        return $event.onTick$0();
      }
    },
    GameTable_onTick_closure1: {
      "^": "Closure:0;$this",
      call$1: function(gid) {
        var t1, t2, g, t3;
        t1 = this.$this;
        t2 = t1.object;
        g = t2.$index(0, gid);
        C.JSArray_methods.remove$1(t1.ghosts, g);
        t1 = t1.field;
        t3 = g.get$pos().get$X();
        if (t3 >>> 0 !== t3 || t3 >= t1.length)
          return H.ioore(t1, t3);
        J.$indexSet$ax(J.$index$asx(t1[t3], g.get$pos().get$Y()), 1, 11);
        t2.$indexSet(0, gid, null);
      }
    },
    GameTable_adjGhostSpeed_closure: {
      "^": "Closure:0;speed",
      call$1: function(ghost) {
        return ghost.adjustSpeed$1(this.speed);
      }
    },
    GameTable_removeEvent_closure: {
      "^": "Closure:0;",
      call$1: function(ghost) {
        return ghost.normSpeed$0();
      }
    },
    GameTable_generateGameTable_closure: {
      "^": "Closure:0;$this",
      call$1: function(i) {
        return P.List_List$generate(this.$this.DIM, new L.GameTable_generateGameTable__closure(), true, null);
      }
    },
    GameTable_generateGameTable__closure: {
      "^": "Closure:0;",
      call$1: function(j) {
        return P.List_List$filled(2, 0, false, null);
      }
    }
  }], ["", "../lib/Model/Ghost.dart",, G, {
    "^": "",
    Ghost: {
      "^": "GameObject;points>,tick,ghostTickMax,ghostTickTemp,pos<,strategy,gametable,id",
      onTick$0: function() {
        var t1, t2, t3, npos, t4, collisionId;
        t1 = ++this.tick;
        t2 = this.ghostTickTemp;
        if (typeof t2 !== "number")
          return H.iae(t2);
        if (t1 >= t2) {
          this.tick = 0;
          ...
          if (t3 >>> 0 !== t3 || t3 >= t2.length)
            return H.ioore(t2, t3);
          J.$indexSet$ax(J.$index$asx(t2[t3], this.pos.get$Y()), 1, 11);
          npos = this.strategy.move$3(this.pos, t1.nomNom.pos, t1);
          t2 = t1.field;
          t3 = npos.get$X();
          if (t3 >>> 0 !== t3 || t3 >= t2.length)
            return H.ioore(t2, t3);
          t3 = t2[t3];
          t2 = npos.y;
          t3 = J.$eq$(J.$index$asx(J.$index$asx(t3, t2), 1), 11);
          t4 = t1.field;
          if (!t3) {
            t3 = npos.get$X();
            if (t3 >>> 0 !== t3 || t3 >= t4.length)
              return H.ioore(t4, t3);
            collisionId = J.$index$asx(J.$index$asx(t4[t3], t2), 1);
            t2 = J.getInterceptor(collisionId);
            if (t2.$eq(collisionId, 0) || t2.$eq(collisionId, 1) || t2.$eq(collisionId, 2) || t2.$eq(collisionId, 4) || t2.$eq(collisionId, 3))
              t1.nomNom.collisionGhost$1(this.id);
          } else {
            t1 = npos.get$X();
            if (t1 >>> 0 !== t1 || t1 >= t4.length)
              return H.ioore(t4, t1);
            J.$indexSet$ax(J.$index$asx(t4[t1], t2), 1, this.id);
          }
          this.pos = npos;
          return npos;
        } else
      ...
      adjustSpeed$1: function(speed) {
        this.ghostTickTemp = J.round$0$n(J.$mul$ns(this.ghostTickTemp, speed));
      },
      normSpeed$0: function() {
        this.ghostTickTemp = this.ghostTickMax;
      },
      toString$0: function(_) {
        return C.JSString_methods.$add("Ghost #" + C.JSInt_methods.toString$0(this.id) + " at: ", J.toString$0$(this.pos));
      },
      Ghost$4: function(id, strategy, pos, gametable) {
        var t1 = this.gametable;
        this.points = J.$index$asx(t1.parameters, "ghostPoints");
        t1 = J.$index$asx(t1.parameters, "ghosttickMax");
        this.ghostTickMax = t1;
        this.ghostTickTemp = t1;
      },
      static: {
        Ghost$: function(id, strategy, pos, gametable) {
          var t1 = new G.Ghost(null, 0, null, null, pos, strategy, gametable, id);
          t1.Ghost$4(id, strategy, pos, gametable);
          return t1;
        }
      }
    }
  }], ["", "../lib/Model/Items/Item.dart",, A, {
    "^": "",
    Item: {
      "^": "GameObject;",
      onPickUp$1: function(pm) {
      }
    }
  }], ["", "../lib/Model/ItemEvent.dart",, A, {
    "^": "",
    Event: {
      "^": "Object;tick,type,tickMax,myTable",
      onTick$0: function() {
        var t1, t2;
        t1 = ++this.tick;
        t2 = this.tickMax;
        ...
        if (t1 >= t2)
          switch (this.type) {
            case 30:
              this.myTable.removeEvent$2(1, this);
              break;
            case 31:
              this.myTable.removeEvent$2(1, this);
              break;
            case 40:
              this.myTable.removeEvent$2(2, this);
              break;
            case 41:
              this.myTable.removeEvent$2(2, this);
              break;
            case 50:
              this.myTable.removeEvent$2(3, this);
              break;
          }
      }
    }
  }], ["", "../lib/Model/Strategies/LeftStrategy.dart",, F, {
    "^": "",
    LeftStrategy: {
      "^": "Strategy;_LeftStrategy$_rng,_LeftStrategy$_last",
      move$3: function(currPos, pacmanPos, gt) {
        var positions, movement, t1, t2, t3, t4, right, straight, left, t5;
        positions = gt.adjPos$1(currPos);
        movement = this._LeftStrategy$_last;
        if (movement == null) {
          this._LeftStrategy$_last = currPos;
          t1 = this._LeftStrategy$_rng.nextInt$1(positions.length);
          if (t1 < 0 || t1 >= positions.length)
            return H.ioore(positions, t1);
          return positions[t1];
        }
        t1 = J.getInterceptor$x(currPos);
        t2 = t1.get$x(currPos);
        t3 = J.get$x$x(this._LeftStrategy$_last);
        if (typeof t2 !== "number")
          return t2.$sub();
        if (typeof t3 !== "number")
          return H.iae(t3);
        t3 = t2 - t3;
        t2 = t1.get$y(currPos);
        t4 = J.get$y$x(this._LeftStrategy$_last);
        if (typeof t2 !== "number")
          return t2.$sub();
        if (typeof t4 !== "number")
          return H.iae(t4);
        ...
        if (t3 === 0) {
          ...
          if (typeof t2 !== "number")
            return t2.$sub();
          right = new E.Position(t2 - t4 * -1, t1.get$y(currPos), null);
          t2 = t1.get$x(currPos);
          t3 = t1.get$y(currPos);
          if (typeof t3 !== "number")
            return t3.$add();
          straight = new E.Position(t2, t3 + t4, null);
          t3 = t1.get$x(currPos);
          if (typeof t3 !== "number")
            return t3.$sub();
          left = new E.Position(t3 - t4, t1.get$y(currPos), null);
        } else {
          t2 = t1.get$x(currPos);
          t5 = t1.get$y(currPos);
          if (typeof t5 !== "number")
            return t5.$sub();
          right = new E.Position(t2, t5 - t3, null);
          t5 = t1.get$x(currPos);
          if (typeof t5 !== "number")
            return t5.$add();
          straight = new E.Position(t5 + t3, t1.get$y(currPos), null);
          t5 = t1.get$x(currPos);
          if (typeof t5 !== "number")
            return t5.$sub();
          t1 = t1.get$y(currPos);
          if (typeof t1 !== "number")
            return t1.$sub();
          left = new E.Position(t5 - t4, t1 - t3 * -1, null);
        }
        if (C.JSArray_methods.contains$1(positions, right))
          movement = right;
        if (C.JSArray_methods.contains$1(positions, straight))
          movement = straight;
        if (C.JSArray_methods.contains$1(positions, left))
          movement = left;
        this._LeftStrategy$_last = currPos;
        return movement;
      }
    }
  }], ["", "../lib/Model/NomNom.dart",, M, {
    "^": "",
    NomNom: {
      "^": "GameObject;life,level,points>,eatableGhosts,pos<,myTable,currDirection,desiredDirection,tick,nomNomTickMax,nomNomTickTemp,id",
      onTick$0: function() {
        var t1, t2;
        t1 = ++this.tick;
        t2 = this.nomNomTickTemp;
        if (typeof t2 !== "number")
          return H.iae(t2);
        if (t1 >= t2) {
          this.tick = 0;
          t1 = this.desiredDirection;
          t2 = this.currDirection;
          if (t1 == null ? t2 != null : t1 !== t2)
            if (this.hasFreePosition$1(t1))
          ...
          switch (this.currDirection) {
            case 1:
              ...
              if (typeof t2 !== "number")
                return t2.$sub();
              this.moveToPos$2(new E.Position(t2 - 1, t1.y, null), 4);
              break;
            case 3:
              t1 = this.pos;
              t2 = t1.x;
              if (typeof t2 !== "number")
                return t2.$add();
              this.moveToPos$2(new E.Position(t2 + 1, t1.y, null), 3);
              break;
            case 4:
              t1 = this.pos;
              t2 = t1.x;
              ...
              if (typeof t1 !== "number")
                return t1.$sub();
              this.moveToPos$2(new E.Position(t2, t1 - 1, null), 1);
              break;
            case 2:
              t1 = this.pos;
              t2 = t1.x;
              ...
              if (typeof t1 !== "number")
                return t1.$add();
              this.moveToPos$2(new E.Position(t2, t1 + 1, null), 2);
              break;
          }
        }
      },
      hasFreePosition$1: function(direction) {
        var t1, t2, t3;
        if (direction === 1) {
          t1 = this.myTable.field;
          t2 = this.pos;
          t3 = t2.x;
          if (typeof t3 !== "number")
            return t3.$sub();
          ...
          if (t3 >>> 0 !== t3 || t3 >= t1.length)
            return H.ioore(t1, t3);
          return !J.$eq$(J.$index$asx(J.$index$asx(t1[t3], t2.y), 0), 10);
        }
        if (direction === 3) {
          t1 = this.myTable.field;
          t2 = this.pos;
        ...
        if (direction === 4) {
          ...
          if (typeof t2 !== "number")
            return t2.$sub();
          return !J.$eq$(J.$index$asx(J.$index$asx(t3, t2 - 1), 0), 10);
        }
        if (direction === 2) {
          t1 = this.myTable.field;
          t2 = this.pos;
      ...
      moveToPos$2: function(nPos, nomNomDirection) {
        var t1, t2, t3, t4, id, obj, t5, t6;
        t1 = this.myTable;
        t2 = t1.field;
        t3 = nPos.x;
        if (t3 >>> 0 !== t3 || t3 >= t2.length)
          return H.ioore(t2, t3);
        t4 = nPos.y;
        if (!J.$eq$(J.$index$asx(J.$index$asx(t2[t3], t4), 1), 11)) {
          t2 = t1.field;
          if (t3 >= t2.length)
            return H.ioore(t2, t3);
          this.collisionGhost$1(J.$index$asx(J.$index$asx(t2[t3], t4), 1));
        }
        t2 = t1.field;
        if (t3 >= t2.length)
          return H.ioore(t2, t3);
        if (!J.$eq$(J.$index$asx(J.$index$asx(t2[t3], t4), 0), 11)) {
          t2 = t1.field;
          if (t3 >= t2.length)
            return H.ioore(t2, t3);
          id = J.$index$asx(J.$index$asx(t2[t3], t4), 0);
          if (J.$eq$(id, 10))
            return;
          obj = t1.object.$index(0, id);
          obj.onPickUp$1(this);
          if (obj.id === 20)
            --t1.coins;
          t2 = t1.field;
          if (t3 >= t2.length)
            return H.ioore(t2, t3);
          J.$indexSet$ax(J.$index$asx(t2[t3], t4), 0, 11);
        }
        t2 = t1.field;
        t5 = this.pos;
        t6 = t5.x;
        ...
        J.$indexSet$ax(J.$index$asx(t2[t6], t5.y), 1, 11);
        this.pos = nPos;
        t1 = t1.field;
        if (t3 >= t1.length)
          return H.ioore(t1, t3);
        J.$indexSet$ax(J.$index$asx(t1[t3], t4), 1, nomNomDirection);
      },
      collisionGhost$1: function(id) {
        var t1;
        if (J.$ge$n(id, 100))
          if (this.eatableGhosts) {
            t1 = this.myTable;
            this.modifyPoints$1(J.get$points$x(t1.object.$index(0, id)));
            t1.killedGhosts.push(id);
            return true;
          } else {
            if (J.$le$n(this.life, 1))
              this.myTable.gameOver = true;
            else
              this.life = J.$sub$n(this.life, 1);
            return true;
          }
        return false;
      },
      modifyPoints$1: function(points) {
        var t1 = J.getInterceptor$n(points);
        if (t1.$le(points, 0))
          if (J.$gt$n(this.points, t1.$negate(points)))
            this.points = J.$add$ns(this.points, points);
          else
            this.points = 0;
        else
          this.points = J.$add$ns(this.points, points);
      ...
      NomNom$1: function(myTable) {
        var t1 = this.myTable;
        this.level = J.$index$asx(t1.parameters, "level");
        this.life = J.$index$asx(t1.parameters, "life");
        t1 = J.$index$asx(t1.parameters, "nomNomtickMax");
        this.nomNomTickMax = t1;
        this.nomNomTickTemp = t1;
      },
      static: {
        NomNom$: function(myTable) {
          var t1 = new M.NomNom(null, null, 0, false, null, myTable, null, null, 0, null, null, 0);
          t1.NomNom$1(myTable);
          return t1;
        }
      }
    }
  }], ["", "../lib/Model/Items/PointItem.dart",, U, {
    "^": "",
    PointItem: {
      "^": "Item;points>,type,id",
      onPickUp$1: function(pm) {
        pm.modifyPoints$1(this.points);
      },
      toString$0: function(_) {
        return C.JSString_methods.$add("PointItem, value:", J.toString$0$(this.points));
      }
    }
  }], ["", "../lib/Model/Types/Position.dart",, E, {
    "^": "",
    Position: {
      "^": "Object;x>,y>,z",
      get$X: function() {
      ...
      toString$0: function(_) {
        return "pos_" + J.toString$0$(this.x) + "_" + J.toString$0$(this.y);
      },
      $eq: function(_, pos) {
        var t1, t2;
        if (pos == null)
          return false;
        if (pos instanceof E.Position) {
          t1 = this.x;
          t2 = pos.x;
          if (t1 == null ? t2 == null : t1 === t2) {
            t1 = this.y;
  ...
  }], ["", "../lib/Model/Strategies/RightStrategy.dart",, V, {
    "^": "",
    RightStrategy: {
      "^": "Strategy;_RightStrategy$_rng,_RightStrategy$_last",
      move$3: function(currPos, pacmanPos, gt) {
        var positions, movement, t1, t2, t3, t4, right, straight, left, t5;
        positions = gt.adjPos$1(currPos);
        movement = this._RightStrategy$_last;
        if (movement == null) {
          this._RightStrategy$_last = currPos;
          t1 = this._RightStrategy$_rng.nextInt$1(positions.length);
          if (t1 < 0 || t1 >= positions.length)
            return H.ioore(positions, t1);
          return positions[t1];
        }
        t1 = J.getInterceptor$x(currPos);
        t2 = t1.get$x(currPos);
        t3 = J.get$x$x(this._RightStrategy$_last);
        if (typeof t2 !== "number")
          return t2.$sub();
        if (typeof t3 !== "number")
          return H.iae(t3);
        t3 = t2 - t3;
        t2 = t1.get$y(currPos);
        t4 = J.get$y$x(this._RightStrategy$_last);
        if (typeof t2 !== "number")
          return t2.$sub();
        if (typeof t4 !== "number")
          return H.iae(t4);
  ...
  }], ["", "../lib/Model/Items/SpecialItem.dart",, V, {
    "^": "",
    SpecialItem: {
      "^": "Item;type,id",
      onPickUp$1: function(pm) {
        ...
        if (t1 === 50) {
          t2 = pm.myTable;
          t1 = new A.Event(0, t1, null, t2);
          t1.tickMax = J.$index$asx(t2.parameters, "EventTicks");
          t2.events.push(t1);
          t1 = !pm.eatableGhosts;
          if (t1)
            pm.eatableGhosts = t1;
          ...
          t1 = pm.myTable;
          g = G.Ghost$(104, new O.FollowStrategy(), t1.getNextGhostSpawnPosition$0(), t1);
          t1.ghosts.push(g);
          t1.object.$indexSet(0, 104, g);
        } else if (t1 === 31) {
          pm.myTable.coins = 0;
          pm.level = J.$add$ns(pm.level, 1);
        }
      }
    }
  }], ["", "../lib/Model/Items/SpeedItem.dart",, M, {
    "^": "",
    SpeedItem: {
      "^": "Item;speed,type,id",
      onPickUp$1: function(pm) {
        ...
        t3 = pm.myTable;
        if (t1 < 40) {
          t1 = new A.Event(0, t1, null, t3);
          t1.tickMax = J.$index$asx(t3.parameters, "EventTicks");
          t3.events.push(t1);
          pm.nomNomTickTemp = J.round$0$n(J.$mul$ns(pm.nomNomTickTemp, t2));
        } else
          t3.adjGhostSpeed$2(t1, t2);
      }
    }
  }], ["", "../lib/Model/Strategies/Strategy.dart",, U, {
    "^": "",
    Strategy: {
      "^": "Object;"
    }
  }], ["", "../lib/View/View.dart",, O, {
    "^": "",
    View: {
      "^": "Object;gameMap,score,life,level,game,legende,buttons,htmlField",
      updateGameField$1: function(gameField) {
        var t1, row, col, t2, td;
        for (t1 = this.gameMap, row = 0; row < gameField.length; ++row) {
          col = 0;
          while (true) {
            if (row >= gameField.length)
              return H.ioore(gameField, row);
            t2 = J.get$length$asx(gameField[row]);
            if (typeof t2 !== "number")
              return H.iae(t2);
            if (!(col < t2))
              break;
            ...
            if (td != null) {
              ...
              t2.get$classes(td).clear$0(0);
              if (row >= gameField.length)
                return H.ioore(gameField, row);
              if (!J.$eq$(J.$index$asx(J.$index$asx(gameField[row], col), 1), 11)) {
                t2 = t2.get$classes(td);
                if (row >= gameField.length)
                  return H.ioore(gameField, row);
                t2.add$1(0, H.S(t1.$index(0, J.$index$asx(J.$index$asx(gameField[row], col), 1))));
              } else {
                t2 = t2.get$classes(td);
                if (row >= gameField.length)
                  return H.ioore(gameField, row);
                t2.add$1(0, H.S(t1.$index(0, J.$index$asx(J.$index$asx(gameField[row], col), 0))));
              }
            }
            ++col;
          }
      ...
      createGameField$1: function(gameField) {
        var t1, table, row, col, t2, assignment;
        for (t1 = this.gameMap, table = "<table>", row = 0; row < gameField.length; ++row) {
          table += "<tr>";
          col = 0;
          while (true) {
            if (row >= gameField.length)
            ...
            if (row >= gameField.length)
              return H.ioore(gameField, row);
            assignment = t1.$index(0, J.$index$asx(J.$index$asx(gameField[row], col), 0));
            table += "<td id='" + ("field_" + row + "_" + col) + "' class='" + H.S(assignment) + "'></td>";
            ++col;
          }
          table += "</tr>";
        }
        t1 = this.game;
        J.set$innerHtml$x(t1, table + "</table>");
        this.htmlField = H.setRuntimeTypeInfo(new Array(gameField.length), [[P.List, W.HtmlElement]]);
        ...
        J.set$innerHtml$x(this.buttons, '<input id="upButton" type="button" value="UP"/><br><input id="leftButton" type="button" value="LEFT"/><input id="downButton" type="button" value="DOWN"/><input id="rightButton" type="button" value="RIGHT"/>');
      },
      updateStats$1: function(pm) {
        var t1, t2, i, t3;
        J.set$innerHtml$x(this.level, C.JSString_methods.$add("Level:", J.toString$0$(pm.level)));
        t1 = this.life;
        t2 = J.getInterceptor$x(t1);
        t2.set$innerHtml(t1, "Life:");
        i = 0;
        while (true) {
          t3 = pm.life;
          if (typeof t3 !== "number")
          ...
          if (t3 == null)
            return t3.$add();
          t2.set$innerHtml(t1, t3 + '<span class="nomNomLeftLife"></span>');
          ++i;
        }
        J.set$innerHtml$x(this.score, "Highscore: " + H.S(pm.points));
      }
    }
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 19, 0],
    ...
    HtmlEscape: {
      ...
      _convert$3: function(text, start, end) {
        ...
        for (t1 = J.getInterceptor$asx(text), i = start, result = null; i < end; ++i) {
          ...
          if (replacement != null) {
            if (result == null)
              result = new P.StringBuffer("");
            if (i > start) {
              t2 = C.JSString_methods.substring$2(text, start, i);
    ...
    EventTarget: {
      ...
      "%": "AnalyserNode|Animation|AudioBufferSourceNode|AudioChannelMerger|AudioChannelSplitter|AudioContext|AudioDestinationNode|AudioGainNode|AudioNode|AudioPannerNode|AudioSourceNode|BatteryManager|BiquadFilterNode|ChannelMergerNode|ChannelSplitterNode|ConvolverNode|CrossOriginServiceWorkerClient|DelayNode|DynamicsCompressorNode|EventSource|GainNode|IDBDatabase|JavaScriptAudioNode|MIDIAccess|MediaController|MediaElementAudioSourceNode|MediaQueryList|MediaSource|MediaStream|MediaStreamAudioDestinationNode|MediaStreamAudioSourceNode|MediaStreamTrack|NetworkInformation|Notification|OfflineAudioContext|Oscillator|OscillatorNode|PannerNode|Performance|Presentation|PresentationAvailability|RTCDTMFSender|RTCPeerConnection|RealtimeAnalyserNode|ScreenOrientation|ScriptProcessorNode|ServicePortCollection|ServiceWorkerContainer|ServiceWorkerRegistration|SpeechRecognition|SpeechSynthesis|SpeechSynthesisUtterance|StashedPortCollection|StereoPannerNode|WaveShaperNode|WorkerPerformance|mozRTCPeerConnection|webkitAudioContext|webkitAudioPannerNode|webkitRTCPeerConnection;EventTarget;EventTarget_ListMixin|EventTarget_ListMixin_ImmutableListMixin|EventTarget_ListMixin0|EventTarget_ListMixin_ImmutableListMixin0"
    },
    FieldSetElement: {
      "^": "HtmlElement;name=",
      "%": "HTMLFieldSetElement"
  ...
  }], ["", "../lib/Model/LevelGen/field.dart",, F, {
    "^": "",
    Field: {
      "^": "Object;dimX,dimY,freeFields,field",
      toString$0: function(_) {
        var t1, t2, ret, _i, t3;
        for (t1 = this.field, t2 = t1.length, ret = "", _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          for (t3 = J.get$iterator$ax(t1[_i]); t3.moveNext$0();)
            ret += J.$eq$(t3.get$current(), 10) ? "#" : " ";
          ret += "\n";
        }
        return ret;
      },
      Field$2: function(dimX, dimY) {
        this.field = P.List_List$generate(this.dimY, new F.Field_closure(this), true, null);
      },
      static: {
        Field$: function(dimX, dimY) {
          var t1 = new F.Field(dimX, dimY, 0, null);
          t1.Field$2(dimX, dimY);
          return t1;
        }
      }
    },
    Field_closure: {
      "^": "Closure:0;$this",
      call$1: function(i) {
        return P.List_List$filled(this.$this.dimX, 10, false, null);
      }
    }
  ...
  }], ["", "../lib/Model/LevelGen/levelGen.dart",, N, {
    "^": "",
    LevelGen: {
      "^": "Object;dim,rng,field,_mapJson",
      parseJsonMap$1: function(level) {
        var map, t1, i, t2, j, t3, t4, t5;
        map = J.$index$asx(J.$index$asx(J.$index$asx(this._mapJson, "level"), J.$sub$n(level, 1)), "map");
        t1 = J.getInterceptor$asx(map);
        this.field = F.Field$(t1.get$length(map), t1.get$length(map));
        i = 0;
        while (true) {
          ...
          j = 0;
          while (true) {
            t2 = J.get$length$asx(t1.$index(map, 0));
            if (typeof t2 !== "number")
              return H.iae(t2);
            if (!(j < t2))
              break;
            t2 = this.field;
            t3 = H.Primitives_parseInt(J.$index$asx(t1.$index(map, i), j), null, null);
            t2.toString;
            if (J.$eq$(t3, 11)) {
              t4 = t2.field;
              t5 = t2.dimX;
              ...
              if (typeof t4 !== "number")
                return H.iae(t4);
              t4 = !J.$eq$(J.$index$asx(t5, C.JSInt_methods.$mod(j, t4)), t3);
            } else
              t4 = false;
            if (t4)
              ++t2.freeFields;
            ...
            if (typeof t2 !== "number")
              return H.iae(t2);
            J.$indexSet$ax(t5, C.JSInt_methods.$mod(j, t2), t3);
            ++j;
          }
          ++i;
        }
      ...
      var $async$main = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = new A.DataLoader(false, false, false, null, null, null, new Y.Starter(), "http://localhost:63342/webtech2016/web/", "gamekey.json", "parameter.json", "fielddata.json");
              $.loader = t1;
              t1.loadData$0();
              // implicit return
              return P._asyncHelper(null, 0, $async$completer, null);
    ...
    }, "call$0", "start__main$closure", 0, 0, 1],
    Starter: {
      "^": "Object;",
      startGame$0: function() {
        var port, host, bt_register, bt_login, bt_offline, bt_highscore, t1;
        port = J.$index$asx($.loader.gamekeyData, "port");
        host = J.$index$asx($.loader.gamekeyData, "host");
        $.gameID = J.$index$asx($.loader.gamekeyData, "id");
        $.gameSecret = J.$index$asx($.loader.gamekeyData, "secret");
        bt_register = document.querySelector("#registerButton");
        bt_login = document.querySelector("#loginButton");
        bt_offline = document.querySelector("#offlineButton");
        bt_highscore = document.querySelector("#highscoreButton");
        t1 = J.get$onClick$x(bt_offline);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Starter_startGame_closure()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(bt_highscore);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Starter_startGame_closure0(this, port, host)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(bt_login);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Starter_startGame_closure1(this, port, host)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(bt_register);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Starter_startGame_closure2(this, port, host)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      },
      register$0: function(_) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, welcome, inputname, inputpassword, inputemail, inputbutton, score, t1;
        var $async$register$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                J.set$innerHtml$x(welcome, '<p id="login">Bitte registriere dich um die Onlinefunktion zu nutzen!</p>Loginname: <input id="name" type="text" placeholder="Hier Namen eingeben..."><br>Password: <input id="password" type="password" placeholder="Hier Passwort eingeben..."><br>Email: <input id="mail" type="text" placeholder="Hier Email eingeben..."><br><input id="confirmButton" type="button" value="Register"><p id="wrong" style="text-decoration-color: red"></p>');
                inputname = document.querySelector("#name");
                inputpassword = document.querySelector("#password");
                inputemail = document.querySelector("#mail");
                document.querySelector("#stats");
                inputbutton = document.querySelector("#confirmButton");
                score = document.querySelector("#score");
                t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [H.getTypeArgumentByIndex(C.EventStreamProvider_keydown, 0)]);
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Starter_register_closure($async$self, welcome, inputname, inputpassword, inputemail, score)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = J.get$onClick$x(inputbutton);
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Starter_register_closure0($async$self, welcome, inputname, inputpassword, inputemail, score)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
              case 1:
                // rethrow
        ...
        return P._asyncHelper(null, $async$register$0, $async$completer, null);
      },
      login$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, welcome, inputbutton, inputname, inputpassword, score, t1;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                welcome = document.querySelector("#welcome");
                J.set$innerHtml$x(welcome, '<p id="login">Bitte logge Dich ein!</p>Loginname: <input id="name" type="text" placeholder="Hier Namen eingeben..."><br>Password: <input id="password" type="password" placeholder="Hier Passwort eingeben..."><br><input id="confirmButton" type="button" value="Login"><p id="wrong" style="text-decoration-color: red"></p>');
                ...
                score = document.querySelector("#score");
                t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [H.getTypeArgumentByIndex(C.EventStreamProvider_keydown, 0)]);
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Starter_login_closure($async$self, welcome, inputname, inputpassword, score)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = J.get$onMouseDown$x(inputbutton);
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.Starter_login_closure0($async$self, welcome, inputname, inputpassword, score)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
              case 1:
                // rethrow
      ...
      highScore$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], map, $name, points, mappoints, gamestates, t1, gamestate, t2, exception, list, key, html, _i, element;
        var $async$highScore$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
            ...
            $async$outer:
              switch ($async$goto) {
                case 0:
                  // Function start
                  $async$goto = 3;
                  return P._asyncHelper($.gamekey.getStates$0(), $async$highScore$0, $async$completer);
                case 3:
                  // returning from await.
                  gamestates = $async$result;
                  map = P.LinkedHashMap__makeEmpty();
                  $name = null;
                  points = null;
                  for (t1 = J.get$iterator$ax(gamestates); t1.moveNext$0();) {
                    gamestate = t1.get$current();
                    t2 = J.getInterceptor$asx(gamestate);
                    $name = t2.$index(gamestate, "username");
                    points = J.$index$asx(t2.$index(gamestate, "state"), "points");
                    if (J.containsKey$1$x(map, $name)) {
                      mappoints = J.$index$asx(map, $name);
                      try {
                        if (J.$ge$n(points, mappoints))
                          J.$indexSet$ax(map, $name, points);
                        else
                          ;
                      } catch (exception) {
                        H.unwrapException(exception);
                  ...
                  list = [];
                  for (t1 = J.get$iterator$ax(J.get$keys$x(map)); t1.moveNext$0();) {
                    key = t1.get$current();
                    if (J.$index$asx(map, key) == null)
                      J.$indexSet$ax(map, key, 0);
                    else
                      ;
                    list.push([key, J.$index$asx(map, key)]);
                  }
                  C.JSArray_methods.checkMutable$1(list, "sort");
                  H.Sort__doSort(list, 0, list.length - 1, new Y.Starter_highScore_closure());
                  for (t1 = list.length, html = "<p><h1>Highscore</h1></p><table><tr><td>Name</td><td>Score</td></tr>", _i = 0; _i < list.length; list.length === t1 || (0, H.throwConcurrentModificationError)(list), ++_i) {
                    element = list[_i];
                    if (0 >= element.length) {
                      $async$returnValue = H.ioore(element, 0);
                      // goto return
                      $async$goto = 1;
                      break $async$outer;
                    } else
                      ;
                    t2 = "<tr><td>" + H.S(element[0]) + "</td><td>";
                    if (1 >= element.length) {
                      $async$returnValue = H.ioore(element, 1);
                      // goto return
                      $async$goto = 1;
                      break $async$outer;
                    } else
                      ;
                    html += t2 + H.S(element[1]) + "</td></tr>";
                  }
                  html += "</table>";
                  J.set$innerHtml$x(document.querySelector("#nomNomtable"), html);
                case 1:
                  // return
                  return P._asyncHelper($async$returnValue, 0, $async$completer, null);
                case 2:
        ...
        return P._asyncHelper(null, $async$highScore$0, $async$completer, null);
      }
    },
    Starter_startGame_closure: {
      "^": "Closure:5;",
      call$1: function(mw) {
        var t1, t2;
        t1 = O.GameKey$("", 0, $.gameID, $.gameSecret);
        $.gamekey = t1;
        t1.offline = true;
        J.set$innerHtml$x(document.querySelector("#welcome"), '<input id="pauseButton" type="button" value="Pause">');
        J.set$innerHtml$x(document.querySelector("#score"), "Score:");
        t1 = $.gamekey;
        t2 = $.loader;
        t2 = new B.Controller(null, null, false, false, true, null, t1, null, null, null, t2.mapData, t2.parameters);
        t2.startController$0();
        $.con = t2;
      }
    },
    Starter_startGame_closure0: {
      "^": "Closure:31;$this,port,host",
      call$1: function(e) {
        ...
        var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                t1 = O.GameKey$($async$self.host, $async$self.port, $.gameID, $.gameSecret);
                $.gamekey = t1;
                t1.offline = false;
                $async$goto = 2;
                return P._asyncHelper(t1.authenticate$0(), $async$call$1, $async$completer);
              case 2:
                // returning from await.
                $async$self.$this.highScore$0();
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
              case 1:
                // rethrow
    ...
    Starter_startGame_closure1: {
      "^": "Closure:13;$this,port,host",
      call$1: function(mv) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, t1;
        var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
    ...
    Starter_register_closure: {
      "^": "Closure:14;$this,welcome,inputname,inputpassword,inputemail,score",
      call$1: function(ev) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, t2, $async$temp1;
        var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = J.get$keyCode$x(ev) === 13 ? 3 : 4;
                break;
              case 3:
                // then
                $.gamekey.username = C.HtmlEscape_gsm.convert$1(J.get$value$x($async$self.inputname));
                $.gamekey.userpw = C.HtmlEscape_gsm.convert$1(J.get$value$x($async$self.inputpassword));
                $.gamekey.usermail = C.HtmlEscape_gsm.convert$1(J.get$value$x($async$self.inputemail));
                t1 = $.gamekey;
                $async$goto = t1._available ? 5 : 6;
                break;
              case 5:
                // then
                $async$temp1 = t1;
                $async$goto = 7;
                return P._asyncHelper(t1.registerUser$3(t1.username, t1.userpw, t1.usermail), $async$call$1, $async$completer);
              case 7:
                // returning from await.
                $async$temp1.params = $async$result;
                t1 = $.gamekey;
                t2 = t1.params;
                if (t2 == null) {
                  J.set$innerHtml$x(document.querySelector("#wrong"), "Name or Password cannot be Empty or Email is wrong");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                  ;
                t1.userid = J.$index$asx(t2, "id");
              case 6:
                // join
                J.set$innerHtml$x($async$self.welcome, C.JSString_methods.$add("Spieler: ", $.gamekey.username) + ' <input id="pauseButton" type="button" value="Pause">');
                J.set$innerHtml$x($async$self.score, "Score:");
                t1 = $.gamekey;
                t2 = $.loader;
                t2 = new B.Controller(null, null, false, false, true, null, t1, null, null, null, t2.mapData, t2.parameters);
                t2.startController$0();
    ...
    Starter_register_closure0: {
      "^": "Closure:15;$this,welcome,inputname,inputpassword,inputemail,score",
      call$1: function(ev) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, t2, $async$temp1;
        var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 5:
                ...
                t2 = t1.params;
                if (t2 == null) {
                  J.set$innerHtml$x(document.querySelector("#wrong"), "Name, Password or Email is wrong");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
    ...
    Starter_login_closure: {
      "^": "Closure:14;$this,welcome,inputname,inputpassword,score",
      call$1: function(ev) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, t2, t3, $async$temp1;
        var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 3:
                // then
                t1 = $async$self.inputname;
                t2 = J.getInterceptor$x(t1);
                $async$goto = t2.get$value(t1) !== "" && J.get$value$x($async$self.inputpassword) !== "" ? 5 : 7;
                break;
              case 5:
                // then
                $.gamekey.username = C.HtmlEscape_gsm.convert$1(t2.get$value(t1));
                $.gamekey.userpw = C.HtmlEscape_gsm.convert$1(J.get$value$x($async$self.inputpassword));
                t1 = $.gamekey;
                $async$goto = t1._available ? 8 : 9;
                break;
              case 8:
                // then
                $async$temp1 = t1;
                $async$goto = 10;
                return P._asyncHelper(t1.getUserId$1(t1.username), $async$call$1, $async$completer);
              case 10:
                // returning from await.
                $async$temp1.userid = $async$result;
                t1 = $.gamekey;
                $async$temp1 = t1;
                $async$goto = 11;
                return P._asyncHelper(t1.getUser$2(t1.userid, t1.userpw), $async$call$1, $async$completer);
              case 11:
                // returning from await.
                $async$temp1.params = $async$result;
                if ($.gamekey.params == null) {
                  J.set$innerHtml$x(document.querySelector("#wrong"), "Wrong Data!");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
              ...
              case 9:
                // join
                t1 = $async$self.welcome;
                J.set$innerHtml$x(t1, '<input id="newGameButton" type="button" value="New Game"><br><input id="loadGameButton" type="button" value="Load Game"><br>');
                t2 = J.get$onClick$x(document.querySelector("#loadGameButton"));
                t3 = $async$self.score;
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Y.Starter_login__closure1(t1, t3)), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
                t2 = J.get$onClick$x(document.querySelector("#newGameButton"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Y.Starter_login__closure2(t1, t3)), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
                // goto join
                $async$goto = 6;
                break;
              case 7:
    ...
    Starter_login__closure1: {
      "^": "Closure:5;welcome,score",
      call$1: function(ev) {
        var t1, t2;
        J.set$innerHtml$x(this.welcome, C.JSString_methods.$add("Spieler: ", $.gamekey.username) + ' <input id="pauseButton" type="button" value="Pause">');
        J.set$innerHtml$x(this.score, "Score:");
        t1 = $.gamekey;
        t2 = $.loader;
        t2 = new B.Controller(null, null, false, false, false, null, t1, null, null, null, t2.mapData, t2.parameters);
        t2.startController$0();
        $.con = t2;
      }
    },
    Starter_login__closure2: {
      "^": "Closure:5;welcome,score",
      call$1: function(ev) {
        var t1, t2;
        J.set$innerHtml$x(this.welcome, C.JSString_methods.$add("Spieler: ", $.gamekey.username) + ' <input id="pauseButton" type="button" value="Pause">');
    ...
    Starter_login_closure0: {
      "^": "Closure:15;$this,welcome,inputname,inputpassword,score",
      call$1: function(ev) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, t2, t3, $async$temp1;
        var $async$call$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t1 = $async$self.inputname;
                t2 = J.getInterceptor$x(t1);
                $async$goto = t2.get$value(t1) !== "" && J.get$value$x($async$self.inputpassword) !== "" ? 3 : 5;
                break;
              case 3:
                // then
                $.gamekey.username = C.HtmlEscape_gsm.convert$1(t2.get$value(t1));
              ...
              case 7:
                ...
                t2 = J.get$onClick$x(document.querySelector("#loadGameButton"));
                t3 = $async$self.score;
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Y.Starter_login__closure(t1, t3)), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
                t2 = J.get$onClick$x(document.querySelector("#newGameButton"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new Y.Starter_login__closure0(t1, t3)), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
                // goto join
                $async$goto = 4;
                break;
              case 5:
                // else
                J.set$innerHtml$x(document.querySelector("#wrong"), "User not found!");
              case 4:
                // join
              case 1:
                // return
    ...
    Starter_highScore_closure: {
      "^": "Closure:3;",
      call$2: function(a, b) {
        return J.$sub$n(J.$index$asx(b, 1), J.$index$asx(a, 1));
      }
    }
  }, 1]];
  setupProgram(dart, 0);
  ...
  C.EventStreamProvider_success = H.setRuntimeTypeInfo(new W.EventStreamProvider("success"), [W.Event0]);
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, args: [W.MouseEvent]}, {func: 1, args: [W.Event0]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: W.Node}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, ret: P.Future, args: [W.Event0]}, {func: 1, ret: P.Future, args: [W.KeyboardEvent]}, {func: 1, ret: P.Future, args: [W.MouseEvent]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [W.KeyboardEvent]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.String, P.String]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.Future}, {func: 1, ret: P.Object, opt: [P.Object]}, {func: 1, args: [W.HttpRequest]}, {func: 1, args: [, P.String]}, {func: 1, v: true, args: [W.Node, W.Node]}, {func: 1, v: true, opt: [P.Object]}, {func: 1, ret: P.Future, args: [,]}, {func: 1, args: [P.String]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(Y.start__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(Y.start__main$closure(), a);
