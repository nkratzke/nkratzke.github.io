...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _Completer: {
      ...
      }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 9, 0]
    },
    _AsyncCompleter: {
      "^": "_Completer;future",
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 17, 0],
    ...
    _StreamIteratorImpl: {
      ...
      }, "_onError$1", "call$2", "call$1", "get$_onError", 2, 2, 9, 0],
      _onDone$0: [function() {
        if (this._state === 2) {
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 19],
    ...
    _TakeStream: {
      ...
      _handleData$2: function(inputEvent, sink) {
        var count = sink.get$_count(sink);
        if (count.$gt(0, 0)) {
  ...
  }], ["spacepeons", "package:SpacePeons/spacepeons.dart",, S, {
    "^": "",
    PowerUpKind: {
      "^": "Object;index",
      toString$0: function(_) {
        return C.Map_O9Feh.$index(0, this.index);
      },
      static: {
        "^": "PowerUpKind_Weapon<"
      }
    ...
    SpacePeonsController: {
      "^": "Object;_ignoreInput,_view,_game,_gamekey",
      startGame$1: [function(e) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$next = [], $async$self = this, error, stacktrace, t1, t2, exception;
        var $async$startGame$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                t1 = J.get$onClick$x(document.querySelector("#left"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone($async$self.get$mobile_left()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = J.get$onClick$x(document.querySelector("#right"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone($async$self.get$mobile_right()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = J.get$onClick$x(document.querySelector("#fire"));
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone($async$self.get$mobile_fire()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [H.getTypeArgumentByIndex(C.EventStreamProvider_keydown, 0)]);
                H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone($async$self.get$input()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
                $async$goto = J.get$innerHtml$x(document.querySelector("#difficulty")) === "Leicht" ? 2 : 3;
                break;
              case 2:
                // then
                $async$goto = 4;
                return P._asyncHelper($async$self._game.LoadConfig$1("gameconfigeasy.json"), $async$startGame$1, $async$completer);
              case 4:
                // returning from await.
              case 3:
                // join
                $async$goto = J.get$innerHtml$x(document.querySelector("#difficulty")) === "Mittel" ? 5 : 6;
                break;
              case 5:
                // then
                $async$goto = 7;
                return P._asyncHelper($async$self._game.LoadConfig$1("gameconfigmedium.json"), $async$startGame$1, $async$completer);
              case 7:
                // returning from await.
              case 6:
                // join
                $async$goto = J.get$innerHtml$x(document.querySelector("#difficulty")) === "Schwer" ? 8 : 9;
                break;
              case 8:
                // then
                $async$goto = 10;
                return P._asyncHelper($async$self._game.LoadConfig$1("gameconfighard.json"), $async$startGame$1, $async$completer);
              case 10:
                // returning from await.
              case 9:
                // join
                t1 = J.get$innerHtml$x(document.querySelector("#playmode"));
                t2 = $async$self._game;
                $async$goto = t1 === "Endless" ? 11 : 13;
                break;
              case 11:
                // then
                $async$goto = 14;
                return P._asyncHelper(t2.startGame$1("endlesslevel1.json"), $async$startGame$1, $async$completer);
              case 14:
                // returning from await.
                // goto join
                $async$goto = 12;
              ...
              case 13:
                // else
                $async$goto = 15;
                return P._asyncHelper(t2.startGame$1("arcadelevel1.json"), $async$startGame$1, $async$completer);
              case 15:
                // returning from await.
              case 12:
                // join
                t1 = $async$self._view;
                t2 = $async$self._game;
                t1.buildField$2(t2._col, t2._row);
                P.Timer_Timer$periodic(C.Duration_40000, $async$self.get$updateFrame());
                try {
                  P.Timer_Timer$periodic(C.Duration_30000000, new S.SpacePeonsController_startGame_closure($async$self));
                } catch (exception) {
                  t1 = H.unwrapException(exception);
                  error = t1;
                  stacktrace = H.getTraceFromException(exception);
                  P.print("Controller caused error " + H.S(error));
                  P.print(H.S(stacktrace));
                  $async$self._view.toString;
                  J.set$innerHtml$x(document.querySelector("#statusWindow"), "Gamekey-Settings konnten nicht geladen werden, keine Highscores verf\xfcgbar");
                }
                // implicit return
      ...
      }, "call$1", "get$startGame", 2, 0, 6],
      updateFrame$1: [function(e) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, t1, t2;
        var $async$updateFrame$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$self._game.updateFrame$0();
                if (J.$eq$($async$self._game._gamestate, C.Symbol_running)) {
                  $async$self.updateView$0();
                  $async$self._ignoreInput = false;
                } else
                  ;
                if (J.$eq$($async$self._game._gamestate, C.Symbol_levelWon)) {
                  t1 = $async$self._game;
                  t2 = J.$add$ns(t1._levelCounter, 1);
                  t1._levelCounter = t2;
                  if (J.$lt$n(t2, J.get$length$asx(t1._level))) {
                    C.JSArray_methods.set$length(t1._hero, 0);
                    t1._hero.push(t1._heroShip);
                    t1.buildLevel$0();
                  } else
                    t1._gamestate = C.Symbol_gameWon;
                  t1 = $async$self._view;
                  t2 = $async$self._game;
                  t1.buildField$2(t2._col, t2._row);
                } else
                  ;
                if (J.$eq$($async$self._game._gamestate, C.Symbol_pause))
                  ;
                else
                  ;
                if (J.$eq$($async$self._game._gamestate, C.Symbol_gameOver)) {
                  t1 = $async$self._view;
                  t2 = $async$self._game._punkte;
                  t1.toString;
                  t1 = document.querySelector("#gui").style;
                  t1.display = "none";
                  t1 = document.querySelector("table").style;
                  t1.display = "none";
                  t1 = document.querySelector("#gameoverscreen").style;
                  t1.display = "block";
                  J.set$innerHtml$x(document.querySelector("#punkte"), "Punkte: " + C.JSNumber_methods.toString$0(t2));
                } else
                  ;
                if (J.$eq$($async$self._game._gamestate, C.Symbol_gameWon)) {
                  t1 = $async$self._view;
                  t2 = $async$self._game._punkte;
                  t1.toString;
                  t1 = document.querySelector("#gui").style;
                  ...
                  t1 = document.querySelector("#gameoverscreen").style;
                  t1.display = "block";
                  H.interceptedTypeCast(document.querySelector("#gameover"), "$isImageElement").src = "../pictures/Win.png";
                  J.set$innerHtml$x(document.querySelector("#punkte"), "Punkte: " + C.JSNumber_methods.toString$0(t2));
                } else
                  ;
                // implicit return
        ...
        return P._asyncHelper(null, $async$updateFrame$1, $async$completer, null);
      }, "call$1", "get$updateFrame", 2, 0, 26],
      initGameKey$1: function(path) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$next = [], $async$self = this, request, exception, settings, t1, t2, $async$exception;
        var $async$initGameKey$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$handler = 3;
                $async$goto = 6;
                return P._asyncHelper(W.HttpRequest_getString(path, null, null), $async$initGameKey$1, $async$completer);
              case 6:
                // returning from await.
              ...
              case 3:
                ...
                P.print("Couldn't open " + H.S(path));
                // goto after finally
                $async$goto = 5;
                break;
              case 2:
              ...
              case 5:
                // after finally
                settings = C.JsonCodec_null_null.decode$1(request);
                t1 = J.getInterceptor$asx(settings);
                t2 = t1.$index(settings, "gameid");
                t2 = new S.GameKey(P.Uri__makeHttpUri("http", H.S(t1.$index(settings, "host")) + ":" + H.S(t1.$index(settings, "port")), "/", null), t2, "bdc8ebdd4f394719", false);
                $async$self._gamekey = t2;
                $async$goto = 7;
                return P._asyncHelper(t2.authenticate$0(), $async$initGameKey$1, $async$completer);
              case 7:
                // returning from await.
                if ($async$result !== true) {
                  $async$self._view.toString;
                  J.set$innerHtml$x(document.querySelector("#statusWindow"), "Gamekey-Service offline, keine Highscores verf\xfcgbar");
                } else
                  ;
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
        ...
        return P._asyncHelper(null, $async$initGameKey$1, $async$completer, null);
      },
      getHighscore$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, scores, states, error, stacktrace, exception, t1, $async$exception;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$handler = 4;
                $async$goto = 7;
                return P._asyncHelper($async$self._gamekey.getStates$0(), $async$getHighscore$0, $async$completer);
              case 7:
                // returning from await.
                states = $async$result;
                scores = J.map$1$ax(states, new S.SpacePeonsController_getHighscore_closure()).toList$0(0);
                J.sort$1$ax(scores, new S.SpacePeonsController_getHighscore_closure0());
                $async$handler = 2;
                // goto after finally
                $async$goto = 6;
                break;
      ...
      showHighscore$1: [function(e) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, highscore;
        var $async$showHighscore$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = 2;
                return P._asyncHelper($async$self._gamekey.authenticate$0(), $async$showHighscore$1, $async$completer);
              case 2:
                // returning from await.
                $async$goto = 3;
                return P._asyncHelper($async$self.getHighscore$0(), $async$showHighscore$1, $async$completer);
              case 3:
                // returning from await.
                highscore = $async$result;
                $async$self._view.showHighscore$1(highscore);
                // implicit return
                return P._asyncHelper(null, 0, $async$completer, null);
              case 1:
                // rethrow
        ...
        return P._asyncHelper(null, $async$showHighscore$1, $async$completer, null);
      }, "call$1", "get$showHighscore", 2, 0, 6],
      setHighscore$1: [function(e) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, $name, pw, id, t1, usr, t2, highscore;
        var $async$setHighscore$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $name = H.interceptedTypeCast(document.querySelector("#name"), "$isInputElement").value;
                pw = H.interceptedTypeCast(document.querySelector("#pw"), "$isInputElement").value;
                $async$goto = 2;
                return P._asyncHelper($async$self._gamekey.getUserId$1($name), $async$setHighscore$1, $async$completer);
              case 2:
                // returning from await.
                id = $async$result;
                t1 = $async$self._gamekey;
                $async$goto = id == null ? 3 : 5;
                break;
              case 3:
                // then
                $async$goto = 6;
                return P._asyncHelper(t1.registerUser$2($name, pw), $async$setHighscore$1, $async$completer);
              case 6:
                // returning from await.
                usr = $async$result;
                t1 = $async$self._view;
                $async$goto = usr != null ? 7 : 9;
                break;
              case 7:
                // then
                t2 = "User " + H.S($name) + " wurde angelegt";
                t1.toString;
                J.set$innerHtml$x(document.querySelector("#statusWindow"), t2);
                $async$goto = 10;
                return P._asyncHelper($async$self._gamekey.storeState$2(J.$index$asx(usr, "id"), P.LinkedHashMap__makeLiteral(["version", "1.0", "points", $async$self._game._punkte])), $async$setHighscore$1, $async$completer);
              case 10:
                // returning from await.
                $async$goto = 11;
                return P._asyncHelper($async$self.getHighscore$0(), $async$setHighscore$1, $async$completer);
              case 11:
                // returning from await.
                highscore = $async$result;
                $async$self._view.showHighscore$1(highscore);
              ...
              case 9:
                // else
                t1.toString;
                J.set$innerHtml$x(document.querySelector("#statusWindow"), "User konnte nicht angelegt werden");
              case 8:
                // join
                // goto join
                $async$goto = 4;
              ...
              case 5:
                // else
                $async$goto = 12;
                return P._asyncHelper(t1.getUser$2(id, pw), $async$setHighscore$1, $async$completer);
              case 12:
                // returning from await.
                usr = $async$result;
                $async$goto = usr == null ? 13 : 15;
                break;
              case 13:
                // then
                t1 = $async$self._view;
                t2 = "Falsches Passwort fuer User '" + H.S($name) + "'";
                t1.toString;
                J.set$innerHtml$x(document.querySelector("#statusWindow"), t2);
                // goto join
                $async$goto = 14;
              ...
              case 16:
                // returning from await.
                $async$self._view.toString;
                J.set$innerHtml$x(document.querySelector("#statusWindow"), "Highscore wurde eingetragen");
                $async$goto = 17;
                return P._asyncHelper($async$self.getHighscore$0(), $async$setHighscore$1, $async$completer);
              case 17:
                // returning from await.
        ...
        return P._asyncHelper(null, $async$setHighscore$1, $async$completer, null);
      }, "call$1", "get$setHighscore", 2, 0, 6],
      reloadWindow$1: [function(e) {
        window.location.reload();
      }, "call$1", "get$reloadWindow", 2, 0, 4],
      changePlaymode$1: [function(e) {
        this._view.toString;
        if (J.get$innerHtml$x(document.querySelector("#playmode")) === "Arcade")
          J.set$innerHtml$x(document.querySelector("#playmode"), "Endless");
        else
          J.set$innerHtml$x(document.querySelector("#playmode"), "Arcade");
      }, "call$1", "get$changePlaymode", 2, 0, 4],
      changeDifficult$1: [function(e) {
        var dif, t1;
        this._view.toString;
        dif = document.querySelector("#difficulty");
        t1 = J.getInterceptor$x(dif);
        switch (t1.get$innerHtml(dif)) {
          case "Leicht":
            t1.set$innerHtml(dif, "Mittel");
            break;
          case "Mittel":
            t1.set$innerHtml(dif, "Schwer");
            break;
          case "Schwer":
            t1.set$innerHtml(dif, "Leicht");
            break;
        }
      }, "call$1", "get$changeDifficult", 2, 0, 4],
      updateView$0: function() {
        var t1, t2, t3, t4;
        t1 = this._view;
        t2 = this._game.calcField$0();
        t3 = J.$add$ns(this._game._levelCounter, 1);
        t4 = this._game;
        t1.updateView$2(t2, [t3, t4._currentLvl, t4._punkte, t4._heroShip.healthPoints, $.HeroDMG]);
      },
      input$1: [function(e) {
        var t1;
        if (J.$eq$(this._game._gamestate, C.Symbol_running)) {
          if (this._ignoreInput !== true) {
            this._ignoreInput = true;
            if (J.get$keyCode$x(e) === 37) {
              this._game._heroShip.move$1(-1);
              this.updateView$0();
            }
            if (e.keyCode === 39) {
              this._game._heroShip.move$1(1);
            ...
            if (e.keyCode === 32) {
              this._game._heroShip.shoot$0();
              this.updateView$0();
            }
            if (e.keyCode === 27) {
              this._game._gamestate = C.Symbol_notRunning;
              this._view.toString;
              t1 = document.querySelector("body").style;
              t1.backgroundImage = "url('../pictures/halbtransparent.png')";
              t1 = document.querySelector("pauseText").style;
              t1.display = "inline";
            }
          }
        } else if (J.$eq$(this._game._gamestate, C.Symbol_stopped))
          if (J.get$keyCode$x(e) === 27) {
            this._game._gamestate = C.Symbol_running;
            this._view.toString;
            t1 = document.querySelector("body").style;
            t1.backgroundImage = "";
            t1 = document.querySelector("pauseText").style;
      ...
      }, "call$1", "get$input", 2, 0, 27],
      mobile_left$1: [function(e) {
        this._game._heroShip.move$1(-1);
        this.updateView$0();
      }, "call$1", "get$mobile_left", 2, 0, 4],
      mobile_right$1: [function(e) {
        this._game._heroShip.move$1(1);
        this.updateView$0();
      }, "call$1", "get$mobile_right", 2, 0, 4],
      mobile_fire$1: [function(e) {
        this._game._heroShip.shoot$0();
        this.updateView$0();
      }, "call$1", "get$mobile_fire", 2, 0, 4]
    },
    SpacePeonsController_startGame_closure: {
      "^": "Closure:28;$this",
      call$1: function(_) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$self = this, t1, t2;
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 2:
                ...
                if (t2 === true) {
                  t1.toString;
                  J.set$innerHtml$x(document.querySelector("#statusWindow"), "");
                } else {
                  t1.toString;
                  J.set$innerHtml$x(document.querySelector("#statusWindow"), "Gamekey-Service offline, keine Highscores verf\xfcgbar");
                }
    ...
    SpacePeonsController_getHighscore_closure: {
      "^": "Closure:0;",
      call$1: function(entry) {
        return P.LinkedHashMap__makeLiteral(["name", H.S(J.$index$asx(entry, "username")), "score", J.$index$asx(J.$index$asx(entry, "state"), "points")]);
      }
    },
    SpacePeonsController_getHighscore_closure0: {
      "^": "Closure:3;",
      call$2: function(a, b) {
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 7:
                // returning from await.
                answer = $async$result;
                if (J.get$status$x(answer) === 401) {
                  t1 = P.LinkedHashMap__makeLiteral(["not", "authorized"]);
                  $async$returnValue = t1;
                  // goto return
                  $async$goto = 1;
                  break;
            ...
            switch ($async$goto) {
              ...
              case 7:
                ...
                if (users == null) {
                  ...
                  ;
                user = J.firstWhere$2$orElse$ax(users, new S.GameKey_getUserId_closure($name), null);
    ...
    SpacePeonsGame: {
      "^": "Object;_EnemyShootDelay,_EnemyShootChance,_shootdelayCounter,_punkte,_rng,_endless,_endlessMothershipcounter,_levelCounter,_gamestate,_hero,_startingBarriers,_heroShip,_heroP,_enemies,_enemyP,_enemyShooter,_powerUps,_level,_field,_col<,_row<,_padding,_currentLvl",
      LoadConfig$1: function(path) {
        ...
        var $async$LoadConfig$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$handler = 3;
                $async$goto = 6;
                return P._asyncHelper(W.HttpRequest_getString(path, null, null).then$1($async$self.get$processParameter()), $async$LoadConfig$1, $async$completer);
              case 6:
                // returning from await.
                $async$handler = 1;
                // goto after finally
        ...
        return P._asyncHelper(null, $async$LoadConfig$1, $async$completer, null);
      },
      processParameter$1: [function(jsonString) {
        var parameter, t1;
        parameter = C.JsonCodec_null_null.decode$1(jsonString);
        t1 = J.getInterceptor$asx(parameter);
        this._EnemyShootChance = t1.$index(parameter, "EnemyShootChance");
        this._EnemyShootDelay = t1.$index(parameter, "EnemyShootDelay");
        this._levelCounter = t1.$index(parameter, "Level");
        $.HeroDMG = t1.$index(parameter, "HeroDMG");
        $.HeroHP = t1.$index(parameter, "HeroHP");
        $.BarrierHP = t1.$index(parameter, "BarrierHP");
        $.MaxHeroP = t1.$index(parameter, "MaxHeroP");
        $.SpeedHeroP = t1.$index(parameter, "SpeedHeroP");
        $.MaxEnemyP = t1.$index(parameter, "MaxEnemyP");
        $.SpeedEnemyP = t1.$index(parameter, "SpeedEnemyP");
        $.PowerUpDropSpeed = t1.$index(parameter, "PowerUpDropSpeed");
        $.MotherShipDmg = t1.$index(parameter, "MotherShipDmg");
        $.MotherShipHp = t1.$index(parameter, "MotherShipHp");
        $.MotherShipSpeed = t1.$index(parameter, "MotherShipSpeed");
        $.MotherShipPoints = t1.$index(parameter, "MotherShipPoints");
        $.PeonDmg = t1.$index(parameter, "PeonDmg");
        $.PeonHp = t1.$index(parameter, "PeonHp");
        $.PeonSpeed = t1.$index(parameter, "PeonSpeed");
        $.PeonPoints = t1.$index(parameter, "PeonPoints");
        $.HpUpWert = t1.$index(parameter, "HpUpWert");
        $.ExtraPointsWert = t1.$index(parameter, "ExtraPointsWert");
        $.HeroDMGIncrease = t1.$index(parameter, "HeroDMGIncrease");
        $.MissileDmgIncrease = t1.$index(parameter, "MissileDmgIncrease");
      }, "call$1", "get$processParameter", 2, 0, 11],
      startGame$1: function(path) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, $async$next = [], $async$self = this, request, exception, $async$exception;
        var $async$startGame$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$handler = 3;
                $async$goto = 6;
                return P._asyncHelper(W.HttpRequest_getString(path, null, null), $async$startGame$1, $async$completer);
              case 6:
                // returning from await.
                request = $async$result;
                $async$self._level = C.JsonCodec_null_null.decode$1(request);
                $async$self.buildLevel$0();
                $async$handler = 1;
                // goto after finally
                $async$goto = 5;
                break;
      ...
      buildLevel$0: function() {
        var t1, newBody, t2, t3, i, Peonswarms, Peonrows, Peons, Motherships, PowerUps, BarrikadenRows, Barrikaden;
        C.JSArray_methods.set$length(this._heroP, 0);
        C.JSArray_methods.set$length(this._enemies, 0);
        C.JSArray_methods.set$length(this._enemyP, 0);
        C.JSArray_methods.set$length(this._startingBarriers, 0);
        C.JSArray_methods.set$length(this._hero, 0);
        this._currentLvl = J.$index$asx(J.$index$asx(this._level, this._levelCounter), "levelname");
        this._col = J.$index$asx(J.$index$asx(this._level, this._levelCounter), "cols");
        this._row = J.$index$asx(J.$index$asx(this._level, this._levelCounter), "rows");
        this._padding = J.$index$asx(J.$index$asx(this._level, this._levelCounter), "padding");
        this._endless = J.$index$asx(J.$index$asx(this._level, this._levelCounter), "endless");
        if (this._heroShip == null) {
          t1 = S.Hero$($.HeroHP, null, this, 3);
          this._heroShip = t1;
        } else {
          newBody = H.setRuntimeTypeInfo([], [S.Pos]);
          t1 = this._row;
          t2 = this._col;
          if (typeof t2 !== "number")
            return t2.$div();
          t3 = new S.Pos(null, null);
          t3._col = C.JSDouble_methods.round$0(t2 / 2);
          t3._row = t1;
          newBody.push(t3);
          t3 = this._row;
          t1 = this._col;
          if (typeof t1 !== "number")
            return t1.$div();
          t2 = new S.Pos(null, null);
          t2._col = C.JSDouble_methods.round$0(t1 / 2) - 1;
          t2._row = t3;
          newBody.push(t2);
          t2 = this._row;
          t3 = this._col;
          if (typeof t3 !== "number")
            return t3.$div();
          t1 = new S.Pos(null, null);
          t1._col = C.JSDouble_methods.round$0(t3 / 2) + 1;
          t1._row = t2;
          newBody.push(t1);
          t1 = J.$sub$n(this._row, 1);
          t2 = this._col;
          if (typeof t2 !== "number")
            return t2.$div();
          t3 = new S.Pos(null, null);
        ...
        i = 0;
        while (true) {
          t1 = J.$mul$ns(this._row, this._col);
          if (typeof t1 !== "number")
            return H.iae(t1);
          if (!(i < t1))
            break;
        ...
        Peonswarms = J.$index$asx(J.$index$asx(this._level, this._levelCounter), "Peonswarms");
        if (Peonswarms != null)
          J.forEach$1$ax(Peonswarms, new S.SpacePeonsGame_buildLevel_closure(this));
        Peonrows = J.$index$asx(J.$index$asx(this._level, this._levelCounter), "Peonrows");
        if (Peonrows != null)
          J.forEach$1$ax(Peonrows, new S.SpacePeonsGame_buildLevel_closure0(this));
        Peons = J.$index$asx(J.$index$asx(this._level, this._levelCounter), "Peons");
        if (Peons != null)
          J.forEach$1$ax(Peons, new S.SpacePeonsGame_buildLevel_closure1(this));
        Motherships = J.$index$asx(J.$index$asx(this._level, this._levelCounter), "Motherships");
        if (Motherships != null)
          J.forEach$1$ax(Motherships, new S.SpacePeonsGame_buildLevel_closure2(this));
        PowerUps = J.$index$asx(J.$index$asx(this._level, this._levelCounter), "PowerUps");
        if (PowerUps != null)
          J.forEach$1$ax(PowerUps, new S.SpacePeonsGame_buildLevel_closure3(this));
        BarrikadenRows = J.$index$asx(J.$index$asx(this._level, this._levelCounter), "BarrikadenRows");
        if (BarrikadenRows != null)
          J.forEach$1$ax(BarrikadenRows, new S.SpacePeonsGame_buildLevel_closure4(this));
        Barrikaden = J.$index$asx(J.$index$asx(this._level, this._levelCounter), "Barrikaden");
        if (Barrikaden != null)
          J.forEach$1$ax(Barrikaden, new S.SpacePeonsGame_buildLevel_closure5(this));
        this._gamestate = C.Symbol_running;
      },
      endlessflood$0: function() {
        var t1, t2, t3, t4, abstandPx, _col;
        t1 = {};
        t1.canSpawn = true;
        t2 = this._enemies;
        C.JSArray_methods.forEach$1(t2, new S.SpacePeonsGame_endlessflood_closure(t1));
        if (t1.canSpawn) {
          t1 = this._rng;
          t3 = t1.nextInt$1(21 - this._endlessMothershipcounter);
          t4 = this._endlessMothershipcounter;
          if (t3 + t4 < 19) {
            this._endlessMothershipcounter = t4 + 1;
            abstandPx = 0;
            _col = 0;
            while (true) {
              t1 = this._col;
              ...
              if (typeof t3 !== "number")
                return H.iae(t3);
              if (_col > t3 && _col + t3 < t1 && abstandPx > 2) {
                t1 = new S.Pos(null, null);
                t1._col = _col;
                t1._row = 1;
                t3 = [];
                t4 = new S.Peon(true, 0, 0, $.PeonDmg, null, null, null, null, t3);
                t4._game = this;
                t4._anchor = t1;
                t3.push(t1);
                t4.HP = $.PeonHp;
            ...
            this._endlessMothershipcounter = 0;
            t3 = new S.Pos(null, null);
            t3._col = t1.nextInt$1(J.$sub$n(this._col, 6)) + 3;
            t3._row = 1;
            t2.push(S.MotherShip$(this, t3));
          }
        }
      },
      updateFrame$0: function() {
        if (J.$eq$(this._gamestate, C.Symbol_running)) {
          if (this._endless === true)
            this.endlessflood$0();
          var t1 = this._heroP;
          if (t1.length !== 0) {
            C.JSArray_methods.forEach$1(t1, new S.SpacePeonsGame_updateFrame_closure());
            C.JSArray_methods.checkGrowable$1(t1, "removeWhere");
            C.JSArray_methods._removeWhere$2(t1, new S.SpacePeonsGame_updateFrame_closure0(), true);
          }
          t1 = this._enemyP;
          if (t1.length !== 0) {
            C.JSArray_methods.forEach$1(t1, new S.SpacePeonsGame_updateFrame_closure1());
            C.JSArray_methods.checkGrowable$1(t1, "removeWhere");
            C.JSArray_methods._removeWhere$2(t1, new S.SpacePeonsGame_updateFrame_closure2(), true);
          }
          t1 = this._powerUps;
          if (t1.length !== 0) {
            C.JSArray_methods.forEach$1(t1, new S.SpacePeonsGame_updateFrame_closure3());
            C.JSArray_methods.checkGrowable$1(t1, "removeWhere");
            C.JSArray_methods._removeWhere$2(t1, new S.SpacePeonsGame_updateFrame_closure4(), true);
          }
          t1 = this._enemies;
          if (t1.length !== 0)
            C.JSArray_methods.forEach$1(t1, new S.SpacePeonsGame_updateFrame_closure5());
          C.JSArray_methods.checkGrowable$1(t1, "removeWhere");
          C.JSArray_methods._removeWhere$2(t1, new S.SpacePeonsGame_updateFrame_closure6(), true);
          t1 = this._hero;
          C.JSArray_methods.checkGrowable$1(t1, "removeWhere");
          C.JSArray_methods._removeWhere$2(t1, new S.SpacePeonsGame_updateFrame_closure7(), true);
          this.enemiesShooting$0();
          if (this._endless === true)
            this.endlessflood$0();
          this.setGamestate$0();
        }
      },
      setGamestate$0: function() {
        var t1 = this._enemies;
        if (t1.length === 0 && this._powerUps.length === 0 && this._endless !== true) {
          this._gamestate = C.Symbol_levelWon;
          return;
        }
        C.JSArray_methods.forEach$1(t1, new S.SpacePeonsGame_setGamestate_closure(this));
      },
      enemiesShooting$0: function() {
        var t1, t2;
        t1 = ++this._shootdelayCounter;
        t2 = this._EnemyShootDelay;
        if (typeof t2 !== "number")
          return H.iae(t2);
        if (t1 > t2) {
          this._shootdelayCounter = 0;
          if (this._rng.nextInt$1(this._EnemyShootChance) === 0) {
            t1 = this._enemyP.length;
            t2 = $.MaxEnemyP;
            if (typeof t2 !== "number")
              return H.iae(t2);
            t2 = t1 < t2;
            ...
            t1 = false;
          if (t1) {
            t1 = this._enemyShooter;
            C.JSArray_methods.set$length(t1, 0);
            C.JSArray_methods.forEach$1(this._enemies, new S.SpacePeonsGame_enemiesShooting_closure(this));
            C.JSArray_methods.shuffle$0(t1);
            C.JSArray_methods.get$first(t1).shoot$0();
          }
        }
      },
      calcField$0: function() {
        var t1, t2, i, _i, p, t3, t4;
        for (t1 = this._field, t2 = t1.length, i = 0; i < t2; ++i)
          t1[i] = 0;
        C.JSArray_methods.forEach$1(this._heroP, new S.SpacePeonsGame_calcField_closure(this));
        C.JSArray_methods.forEach$1(this._enemyP, new S.SpacePeonsGame_calcField_closure0(this));
        C.JSArray_methods.forEach$1(this._hero, new S.SpacePeonsGame_calcField_closure1(this));
        C.JSArray_methods.forEach$1(this._enemies, new S.SpacePeonsGame_calcField_closure2(this));
        for (t1 = this._powerUps, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          p = t1[_i];
          if (!!p.$isExtraPoints) {
            t3 = this._field;
            t4 = J.$add$ns(J.$mul$ns(J.$sub$n(p._anchor._row, 1), this._col), p._anchor._col);
      ...
      spawnPowerUp$2: function(pos, kind) {
        var t1;
        switch (kind == null ? this._rng.nextInt$1(5) : kind) {
          case 0:
            t1 = new S.ExtraPoints(null, 0, null, 0, this, pos, false);
            t1._speed = $.SpeedEnemyP;
            t1._speedCounter = 0;
            t1._speed = $.PowerUpDropSpeed;
            t1._kind = C.PowerUpKind_0;
            this._powerUps.push(t1);
            break;
          case 1:
            t1 = new S.WeaponUp(null, 0, null, 0, this, pos, false);
            t1._speed = $.SpeedEnemyP;
            t1._speedCounter = 0;
            t1._speed = $.PowerUpDropSpeed;
            t1._kind = C.PowerUpKind_0;
            ...
            break;
          case 2:
            t1 = new S.HpUp(null, 0, null, 0, this, pos, false);
            t1._speed = $.SpeedEnemyP;
            t1._speedCounter = 0;
            t1._speed = $.PowerUpDropSpeed;
            t1._kind = C.PowerUpKind_0;
            ...
            break;
          case 3:
            t1 = new S.MoreDmgPowerUp(null, 0, null, 0, this, pos, false);
            t1._speed = $.SpeedEnemyP;
            t1._speedCounter = 0;
            t1._speed = $.PowerUpDropSpeed;
            t1._kind = C.PowerUpKind_0;
            ...
            break;
          case 4:
            if (this._startingBarriers.length !== 0) {
              t1 = new S.BarrierUp(null, 0, null, 0, this, pos, false);
              t1._speed = $.SpeedEnemyP;
              t1._speedCounter = 0;
              t1._speed = $.PowerUpDropSpeed;
              t1._kind = C.PowerUpKind_0;
              ...
              this.spawnPowerUp$2(pos, null);
            break;
          case 5:
            t1 = new S.DoubleShot(null, 0, null, 0, this, pos, false);
            t1._speed = $.SpeedEnemyP;
            t1._speedCounter = 0;
            t1._speed = $.PowerUpDropSpeed;
            t1._kind = C.PowerUpKind_1;
            this._powerUps.push(t1);
            break;
          case 6:
            t1 = new S.TripleShot(null, 0, null, 0, this, pos, false);
            t1._speed = $.SpeedEnemyP;
            t1._speedCounter = 0;
            t1._speed = $.PowerUpDropSpeed;
            t1._kind = C.PowerUpKind_1;
            ...
            break;
          case 7:
            t1 = new S.HomeingMissile(null, 0, null, 0, this, pos, false);
            t1._speed = $.SpeedEnemyP;
            t1._speedCounter = 0;
            t1._speed = $.PowerUpDropSpeed;
            t1._kind = C.PowerUpKind_1;
      ...
      spawnBarrikaden$0: function() {
        C.JSArray_methods.set$length(this._hero, 0);
        this._hero.push(this._heroShip);
        C.JSArray_methods.forEach$1(this._startingBarriers, new S.SpacePeonsGame_spawnBarrikaden_closure(this));
      }
    },
    SpacePeonsGame_buildLevel_closure: {
      "^": "Closure:3;$this",
      call$2: function(k, PS) {
        var t1, PSstartingcol, PSendcol, PSabstandPx, PSabstandPy, t2, _row, abstandPy, abstandPx, t3, _col, t4, t5, t6;
        t1 = J.getInterceptor$asx(PS);
        PSstartingcol = t1.$index(PS, "startingcol");
        PSendcol = t1.$index(PS, "endcol");
        PSabstandPx = t1.$index(PS, "abstandPx");
        PSabstandPy = t1.$index(PS, "abstandPy");
        for (t1 = this.$this, t2 = t1._enemies, _row = PSstartingcol, abstandPy = PSabstandPy, abstandPx = 0; t3 = J.getInterceptor$n(_row), t3.$lt(_row, PSendcol); _row = t3.$add(_row, 1)) {
          abstandPy = J.$add$ns(abstandPy, 1);
          if (J.$gt$n(abstandPy, PSabstandPy)) {
            _col = 0;
            while (true) {
              t4 = t1._col;
              if (typeof t4 !== "number")
              ...
              if (_col > t5)
                if (_col + t5 < t4) {
                  if (typeof PSabstandPx !== "number")
                    return H.iae(PSabstandPx);
                  t4 = abstandPx > PSabstandPx;
                } else
                  t4 = false;
              else
                t4 = false;
              if (t4) {
                t4 = new S.Pos(null, null);
                t4._col = _col;
                t4._row = _row;
                t5 = [];
                t6 = new S.Peon(true, 0, 0, $.PeonDmg, null, null, null, null, t5);
                t6._game = t1;
                t6._anchor = t4;
                t5.push(t4);
                t6.HP = $.PeonHp;
    ...
    SpacePeonsGame_buildLevel_closure0: {
      "^": "Closure:3;$this",
      call$2: function(k, PR) {
        var t1, PRcol, PRabstandPx, t2, abstandPx, _col, t3, t4, t5;
        t1 = J.getInterceptor$asx(PR);
        PRcol = t1.$index(PR, "PeonRowCol");
        PRabstandPx = t1.$index(PR, "abstandPx");
        t1 = this.$this;
        t2 = t1._enemies;
        abstandPx = 0;
        _col = 0;
        while (true) {
          ...
          if (_col > t4)
            if (_col + t4 < t3) {
              if (typeof PRabstandPx !== "number")
                return H.iae(PRabstandPx);
              t3 = abstandPx > PRabstandPx;
            } else
              t3 = false;
          else
            t3 = false;
          if (t3) {
            ...
            t3._row = PRcol;
            t4 = [];
            t5 = new S.Peon(true, 0, 0, $.PeonDmg, null, null, null, null, t4);
            t5._game = t1;
            t5._anchor = t3;
            t4.push(t3);
            t5.HP = $.PeonHp;
    ...
    SpacePeonsGame_buildLevel_closure1: {
      "^": "Closure:3;$this",
      call$2: function(k, $P) {
        var t1, Pcol, Prow, t2;
        ...
        t2._col = Pcol;
        t2._row = Prow;
        t1._enemies.push(S.Peon$(t1, t2));
      }
    },
    SpacePeonsGame_buildLevel_closure2: {
      "^": "Closure:3;$this",
      call$2: function(k, MS) {
        var t1, MScol, MSrow, t2;
        t1 = J.getInterceptor$asx(MS);
        MScol = t1.$index(MS, "col");
        MSrow = t1.$index(MS, "row");
        t1 = this.$this;
        t2 = new S.Pos(null, null);
        t2._col = MScol;
        t2._row = MSrow;
        t1._enemies.push(S.MotherShip$(t1, t2));
      }
    },
    SpacePeonsGame_buildLevel_closure3: {
      "^": "Closure:3;$this",
      call$2: function(k, PU) {
        var t1, PUcol, PUrow, PUkind;
        t1 = J.getInterceptor$asx(PU);
        PUcol = t1.$index(PU, "col");
        PUrow = t1.$index(PU, "row");
        PUkind = t1.$index(PU, "kind");
        t1 = new S.Pos(null, null);
        t1._col = PUcol;
        t1._row = PUrow;
        this.$this.spawnPowerUp$2(t1, PUkind);
      }
    },
    SpacePeonsGame_buildLevel_closure4: {
      "^": "Closure:3;$this",
      call$2: function(k, BR) {
        var t1, BRcol, BRabstandBx, t2, t3, abstandBx, _col, t4, t5, newBody, t6, newBarrier;
        t1 = J.getInterceptor$asx(BR);
        BRcol = t1.$index(BR, "BRcol");
        BRabstandBx = t1.$index(BR, "abstandBx");
        t1 = this.$this;
        t2 = J.getInterceptor$n(BRcol);
        t3 = t1._startingBarriers;
        abstandBx = 0;
        _col = 0;
        while (true) {
          t4 = t1._col;
          ...
          if (_col > t5)
            if (_col + t5 < t4) {
              if (typeof BRabstandBx !== "number")
                return H.iae(BRabstandBx);
              t4 = abstandBx > BRabstandBx;
            } else
              t4 = false;
          else
            t4 = false;
          if (t4) {
            ...
            t6._row = BRcol;
            newBody.push(t6);
            newBarrier = S.Barrier$($.BarrierHP, newBody, t1);
            t1._hero.push(newBarrier);
            t3.push(S.Barrier$($.BarrierHP, newBody, t1));
            abstandBx = 0;
          }
          ++_col;
        }
    ...
    SpacePeonsGame_buildLevel_closure5: {
      "^": "Closure:3;$this",
      call$2: function(k, $B) {
        var t1, Bcol, Brow, newBody, t2, t3, t4, newBarrier;
        t1 = J.getInterceptor$asx($B);
        Bcol = t1.$index($B, "col");
        Brow = t1.$index($B, "row");
        newBody = H.setRuntimeTypeInfo([], [S.Pos]);
        t1 = J.getInterceptor$ns(Brow);
        t2 = t1.$add(Brow, 1);
        t3 = J.getInterceptor$n(Bcol);
        t4 = new S.Pos(null, null);
        t4._col = t3.$sub(Bcol, 1);
        t4._row = t2;
        newBody.push(t4);
        t4 = new S.Pos(null, null);
        t4._col = t3.$sub(Bcol, 1);
        ...
        newBody.push(t4);
        t4 = this.$this;
        newBarrier = S.Barrier$($.BarrierHP, newBody, t4);
        t4._hero.push(newBarrier);
        t4._startingBarriers.push(S.Barrier$($.BarrierHP, newBody, t4));
      }
    },
    SpacePeonsGame_endlessflood_closure: {
      "^": "Closure:0;_box_0",
      call$1: function(e) {
        J.forEach$1$ax(J.get$body$x(e), new S.SpacePeonsGame_endlessflood__closure(this._box_0));
      }
    },
    SpacePeonsGame_endlessflood__closure: {
      "^": "Closure:0;_box_0",
      call$1: function(b) {
        if (J.$lt$n(b.get$_row(), 5))
          this._box_0.canSpawn = false;
      }
    },
    SpacePeonsGame_updateFrame_closure: {
      "^": "Closure:0;",
      call$1: function(p) {
        return p.move$0();
      }
    },
    SpacePeonsGame_updateFrame_closure0: {
      "^": "Closure:0;",
      call$1: function(p) {
        return p.get$getHit();
      }
    },
    SpacePeonsGame_updateFrame_closure1: {
      "^": "Closure:0;",
      call$1: function(p) {
        return p.move$0();
      }
    },
    SpacePeonsGame_updateFrame_closure2: {
      "^": "Closure:0;",
      call$1: function(p) {
        return p.get$getHit();
      }
    },
    SpacePeonsGame_updateFrame_closure3: {
      "^": "Closure:0;",
      call$1: function(p) {
        return p.move$0();
      }
    },
    SpacePeonsGame_updateFrame_closure4: {
      "^": "Closure:0;",
      call$1: function(p) {
        return p.get$getHit();
      }
    },
    SpacePeonsGame_updateFrame_closure5: {
      "^": "Closure:0;",
      call$1: function(e) {
        return e.move$0();
      }
    },
    SpacePeonsGame_updateFrame_closure6: {
      "^": "Closure:0;",
      call$1: function(e) {
        return J.$le$n(e.get$HP(), 0);
      }
    },
    SpacePeonsGame_updateFrame_closure7: {
      "^": "Closure:0;",
      call$1: function(h) {
        return J.$le$n(h.get$healthPoints(), 0);
      }
    },
    SpacePeonsGame_setGamestate_closure: {
      "^": "Closure:0;$this",
      call$1: function(e) {
        J.forEach$1$ax(J.get$body$x(e), new S.SpacePeonsGame_setGamestate__closure(this.$this));
      }
    },
    SpacePeonsGame_setGamestate__closure: {
      "^": "Closure:0;$this",
      call$1: function(b) {
        var t1 = this.$this;
        if (J.$gt$n(b.get$_row(), J.$sub$n(t1._row, 2)))
          t1._gamestate = C.Symbol_gameOver;
      }
    },
    SpacePeonsGame_enemiesShooting_closure: {
      "^": "Closure:0;$this",
      call$1: function(e) {
        var t1 = J.getInterceptor(e);
        if (!!t1.$isPeon && e.lowest$0())
          this.$this._enemyShooter.push(e);
        if (!!t1.$isMotherShip)
          this.$this._enemyShooter.push(e);
      }
    },
    SpacePeonsGame_calcField_closure: {
      "^": "Closure:0;$this",
      call$1: function(p) {
        var t1, t2;
        t1 = this.$this;
        t2 = t1._field;
        t1 = J.$add$ns(J.$mul$ns(J.$sub$n(p.get$_anchor()._row, 1), t1._col), p.get$_anchor()._col);
        if (t1 >>> 0 !== t1 || t1 >= t2.length)
          return H.ioore(t2, t1);
        t2[t1] = 1;
      }
    },
    SpacePeonsGame_calcField_closure0: {
      "^": "Closure:0;$this",
      call$1: function(p) {
        var t1, t2;
        t1 = this.$this;
    ...
    SpacePeonsGame_calcField_closure1: {
      "^": "Closure:0;$this",
      call$1: function(h) {
        var t1, t2, t3, t4, p;
        t1 = this.$this;
        t2 = J.getInterceptor(h);
        if (t2.$eq(h, t1._heroShip))
          if (h.get$Weapon() instanceof S.DoubleShot) {
            t2 = t1._field;
            t1 = J.$sub$n(J.$add$ns(J.$mul$ns(J.$sub$n(C.JSArray_methods.get$first(h.body).get$_row(), 2), t1._col), C.JSArray_methods.get$first(h.body).get$_col()), 1);
            if (t1 >>> 0 !== t1 || t1 >= t2.length)
              return H.ioore(t2, t1);
            t2[t1] = 12;
          } else {
            ...
            t3 = t1._field;
            t4 = h.body;
            if (t2 instanceof S.TripleShot) {
              t1 = J.$sub$n(J.$add$ns(J.$mul$ns(J.$sub$n(C.JSArray_methods.get$first(t4).get$_row(), 2), t1._col), C.JSArray_methods.get$first(h.body).get$_col()), 1);
          ...
          for (t2 = J.get$iterator$ax(t2.get$body(h)); t2.moveNext$0();) {
            p = t2.__interceptors$_current;
            t3 = t1._field;
            t4 = J.$add$ns(J.$mul$ns(J.$sub$n(p.get$_row(), 1), t1._col), p.get$_col());
            if (t4 >>> 0 !== t4 || t4 >= t3.length)
              return H.ioore(t3, t4);
            t3[t4] = 11;
          }
    ...
    SpacePeonsGame_calcField_closure2: {
      "^": "Closure:0;$this",
      call$1: function(e) {
        var t1, t2, t3;
        ...
        if (!!t1.$isPeon) {
          t2 = this.$this;
          t3 = t2._field;
          t2 = J.$add$ns(J.$mul$ns(J.$sub$n(e._anchor._row, 1), t2._col), e._anchor._col);
        ...
        if (!!t1.$isMotherShip) {
          t1 = this.$this;
          t2 = t1._field;
          t1 = J.$sub$n(J.$add$ns(J.$mul$ns(J.$sub$n(e._anchor._row, 1), t1._col), e._anchor._col), 1);
          if (t1 >>> 0 !== t1 || t1 >= t2.length)
            return H.ioore(t2, t1);
          t2[t1] = 4;
        }
    ...
    SpacePeonsGame_spawnBarrikaden_closure: {
      "^": "Closure:0;$this",
      call$1: function(b) {
        var t1, newBarrierDummy;
        t1 = this.$this;
        newBarrierDummy = S.Barrier$(b.get$healthPoints(), b.body, t1);
        t1._hero.push(newBarrierDummy);
      }
    },
    Pos: {
      "^": "Object;_row<,_col<",
      equal$1: function(position) {
        if (J.$eq$(position.get$_col(), this._col) && J.$eq$(position.get$_row(), this._row))
          return true;
        else
          return false;
      },
      setRow$1: function(_row) {
        this._row = _row;
      },
      setCol$1: function(_row) {
        this._col = _row;
      }
    },
    Hero: {
      "^": "Barrier;_turret,_weapon,healthPoints,_game,body",
      get$Turret: function() {
        var t1, t2, t3, t4;
        t1 = this.body;
        t2 = this._turret;
        if (t2 >= t1.length)
          return H.ioore(t1, t2);
        t2 = J.$sub$n(t1[t2].get$_row(), 1);
        t1 = this.body;
        t3 = this._turret;
        if (t3 >= t1.length)
          return H.ioore(t1, t3);
        t4 = new S.Pos(null, null);
        t4._col = t1[t3].get$_col();
        t4._row = t2;
        return t4;
      },
      get$Weapon: function() {
      ...
      move$1: function(range) {
        var t1, t2, t3, t4, canMove, _i, posi;
        for (t1 = this.body, t2 = t1.length, t3 = range < 0, t4 = range > 0, canMove = true, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          posi = t1[_i];
          if (J.$eq$(posi.get$_col(), 0) && t3)
            canMove = false;
          if (J.$eq$(posi.get$_col(), J.$sub$n(this._game._col, 1)) && t4)
            canMove = false;
        }
        if (canMove) {
          for (t1 = this.body, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
            posi = t1[_i];
            posi.setCol$1(J.$add$ns(posi.get$_col(), range));
          }
          this.hit$0();
        }
      },
      damage$2: function(dmg, hit) {
        var t1 = J.$sub$n(this.healthPoints, dmg);
        this.healthPoints = t1;
        if (J.$le$n(t1, 0))
          this._game._gamestate = C.Symbol_gameOver;
      },
      shoot$0: function() {
        ...
        if (t1 != null)
          ...
          if (t3 < t4) {
            ...
            t5 = J.$sub$n(t4[t5].get$_row(), 1);
            t4 = this.body;
            t6 = this._turret;
            if (t6 >= t4.length)
              return H.ioore(t4, t6);
            t7 = new S.Pos(null, null);
            t7._col = t4[t6].get$_col();
            t7._row = t5;
            t7 = new S.HeroProjectile(0, null, t3, t1, t7, false);
            t7._speed = $.SpeedHeroP;
            t2.push(t7);
          }
        }
      },
      hit$0: function() {
        C.JSArray_methods.forEach$1(this._game._enemyP, new S.Hero_hit_closure());
      },
      Hero$4: function(hp, position, game, turret) {
        var t1, t2, t3, t4;
        t1 = this.body;
        t2 = this._game;
        t3 = t2._row;
        ...
        if (typeof t2 !== "number")
          return t2.$div();
        t4 = new S.Pos(null, null);
        t4._col = C.JSDouble_methods.round$0(t2 / 2);
        t4._row = t3;
        t1.push(t4);
        t4 = this.body;
        t1 = this._game;
        ...
        if (typeof t4 !== "number")
          return t4.$div();
        t1 = new S.Pos(null, null);
        t1._col = C.JSDouble_methods.round$0(t4 / 2) + 1;
        t1._row = t3;
        t2.push(t1);
        t1 = this.body;
        t2 = J.$sub$n(this._game._row, 1);
        t3 = this._game._col;
        if (typeof t3 !== "number")
          return t3.$div();
        t4 = new S.Pos(null, null);
        t4._col = C.JSDouble_methods.round$0(t3 / 2);
        t4._row = t2;
        t1.push(t4);
        this._turret = turret;
        this._weapon = null;
      ...
      static: {
        Hero$: function(hp, position, game, turret) {
          var t1 = new S.Hero(null, null, null, null, []);
          t1.Barrier$3(hp, position, game);
          t1.Hero$4(hp, position, game, turret);
          return t1;
        }
      }
    },
    ...
    Barrier: {
      "^": "Object;healthPoints<,_game,body>",
      damage$2: function(dmg, hit) {
        var t1 = this.body;
        C.JSArray_methods.checkGrowable$1(t1, "removeWhere");
        C.JSArray_methods._removeWhere$2(t1, new S.Barrier_damage_closure(hit), true);
        if (J.$gt$n(this.healthPoints, 0))
          this.healthPoints = J.$sub$n(this.healthPoints, dmg);
      },
      Barrier$3: function(hp, position, game) {
        var t1, _i, posi;
        this._game = game;
        this.healthPoints = hp;
        if (position != null)
          for (t1 = position.length, _i = 0; _i < position.length; position.length === t1 || (0, H.throwConcurrentModificationError)(position), ++_i) {
            posi = position[_i];
            this.body.push(posi);
          }
      },
      static: {
        Barrier$: function(hp, position, game) {
          var t1 = new S.Barrier(null, null, []);
          t1.Barrier$3(hp, position, game);
          return t1;
        }
      }
    },
    Barrier_damage_closure: {
      "^": "Closure:0;hit",
      call$1: function(p) {
        return p.equal$1(this.hit);
      }
    },
    Projectile: {
      "^": "Object;_anchor<",
    ...
    Missile: {
      "^": "HeroProjectile;aim,_speedCounter,_speed,dmg,_game,_anchor,_hit",
      move$0: function() {
        var t1, t2;
        t1 = {};
        t2 = this.aim;
        if (t2 == null || J.$le$n(t2.get$HP(), 0)) {
          t1.distance = 100;
          t1.newdistance = 0;
          C.JSArray_methods.forEach$1(this._game._enemies, new S.Missile_move_closure(t1, this));
        }
        t1 = this.aim;
        if (t1 != null) {
          t1 = J.$gt$n(J.abs$0$n(J.$sub$n(t1.get$_anchor()._row, this._anchor._row)), J.abs$0$n(J.$sub$n(this.aim.get$_anchor()._col, this._anchor._col)));
          t2 = this.aim;
          if (t1) {
            t1 = J.$gt$n(J.$sub$n(t2.get$_anchor()._row, this._anchor._row), 0);
            t2 = this._anchor;
            if (t1)
              t2._row = J.$add$ns(t2._row, 1);
            else
              t2._row = J.$sub$n(t2._row, 1);
          } else {
            t1 = J.$gt$n(J.$sub$n(t2.get$_anchor()._col, this._anchor._col), 0);
            t2 = this._anchor;
            if (t1)
              t2._col = J.$add$ns(t2._col, 1);
            else
              t2._col = J.$sub$n(t2._col, 1);
          }
        } else {
          t1 = this._anchor;
          t1._row = J.$sub$n(t1._row, 1);
        }
        if (J.$lt$n(this._anchor._row, 2))
          this._hit = true;
        this.hit$0();
      }
    },
    Missile_move_closure: {
      "^": "Closure:0;_box_0,$this",
      call$1: function(e) {
        var t1, newdistance, t2;
        t1 = this.$this;
        newdistance = J.$add$ns(J.abs$0$n(J.$sub$n(e.get$_anchor()._row, t1._anchor._row)), J.abs$0$n(J.$sub$n(e.get$_anchor()._col, t1._anchor._col)));
        t2 = this._box_0;
        t2.newdistance = newdistance;
        if (J.$lt$n(newdistance, t2.distance) && J.$gt$n(e.get$HP(), 0)) {
          t1.aim = e;
          t2.distance = t2.newdistance;
        }
      }
    },
    HeroProjectile: {
      "^": "Projectile;_speedCounter,_speed,dmg,_game,_anchor,_hit",
      move$0: function() {
        var t1, t2;
        t1 = ++this._speedCounter;
        t2 = this._speed;
        if (typeof t2 !== "number")
          return H.iae(t2);
        if (t1 > t2) {
      ...
      hit$0: function() {
        C.JSArray_methods.forEach$1(this._game._enemies, new S.HeroProjectile_hit_closure(this));
      }
    },
    HeroProjectile_hit_closure: {
      "^": "Closure:0;$this",
      call$1: function(e) {
        J.forEach$1$ax(J.get$body$x(e), new S.HeroProjectile_hit__closure(this.$this, e));
      }
    },
    HeroProjectile_hit__closure: {
      "^": "Closure:0;$this,e",
      call$1: function(b) {
        var t1 = this.$this;
        if (t1._anchor.equal$1(b)) {
          t1._hit = true;
          this.e.damage$1(t1.dmg);
        }
      }
    },
    EnemyProjectile: {
      ...
      move$0: function() {
        ...
        if (t1 > t2) {
          this._speedCounter = 0;
          if (J.$gt$n(this._anchor._row, J.$sub$n(this._game._row, 1)))
            this._hit = true;
          else {
            t1 = this._anchor;
            t1._row = J.$add$ns(t1._row, 1);
            this.hit$0();
          }
        }
      },
      hit$0: function() {
        C.JSArray_methods.forEach$1(this._game._hero, new S.EnemyProjectile_hit_closure(this));
      }
    },
    EnemyProjectile_hit_closure: {
      "^": "Closure:0;$this",
      call$1: function(h) {
        J.forEach$1$ax(J.get$body$x(h), new S.EnemyProjectile_hit__closure(this.$this, h));
      }
    },
    EnemyProjectile_hit__closure: {
      "^": "Closure:0;$this,h",
      call$1: function(b) {
        var t1 = this.$this;
        if (t1._anchor.equal$1(b)) {
          t1._hit = true;
          this.h.damage$2(t1.dmg, t1._anchor);
        }
      }
    },
    PowerUp: {
      "^": "EnemyProjectile;",
      hit$0: function() {
        C.JSArray_methods.forEach$1(this._game._heroShip.body, new S.PowerUp_hit_closure(this));
        if (this._hit)
          if (this._kind === C.PowerUpKind_0)
            this.doPowerUpStuff$0();
          else
            this._game._heroShip._weapon = this;
      }
    },
    PowerUp_hit_closure: {
      "^": "Closure:0;$this",
      call$1: function(p) {
        var t1 = this.$this;
        if (t1._anchor.equal$1(p))
          t1._hit = true;
      }
    },
    BarrierUp: {
      "^": "PowerUp;_kind,_speedCounter,_speed,dmg,_game,_anchor,_hit",
      doPowerUpStuff$0: function() {
        this._game.spawnBarrikaden$0();
      }
    },
    HpUp: {
      "^": "PowerUp;_kind,_speedCounter,_speed,dmg,_game,_anchor,_hit",
      doPowerUpStuff$0: function() {
        var t1 = this._game._heroShip;
        t1.healthPoints = J.$add$ns(t1.healthPoints, $.HpUpWert);
      }
    },
    ExtraPoints: {
      "^": "PowerUp;_kind,_speedCounter,_speed,dmg,_game,_anchor,_hit",
    ...
    WeaponUp: {
      ...
      doPowerUpStuff$0: function() {
        ...
        t3 = t2._weapon;
        if (t3 == null) {
          t1 = new S.DoubleShot(null, 0, null, 0, t1, null, false);
          t1._speed = $.SpeedEnemyP;
          t1._speedCounter = 0;
          t1._speed = $.PowerUpDropSpeed;
          t1._kind = C.PowerUpKind_1;
        ...
        t3 = J.getInterceptor(t3);
        if (!!t3.$isDoubleShot) {
          t1 = new S.TripleShot(null, 0, null, 0, t1, null, false);
          t1._speed = $.SpeedEnemyP;
          t1._speedCounter = 0;
          t1._speed = $.PowerUpDropSpeed;
          t1._kind = C.PowerUpKind_1;
        ...
        if (!!t3.$isTripleShot) {
          t1 = new S.HomeingMissile(null, 0, null, 0, t1, null, false);
          t1._speed = $.SpeedEnemyP;
          t1._speedCounter = 0;
          t1._speed = $.PowerUpDropSpeed;
          t1._kind = C.PowerUpKind_1;
    ...
    DoubleShot: {
      ...
      doPowerUpStuff$0: function() {
        ...
        if (t3 < t4) {
          t3 = $.HeroDMG;
          t4 = t1._heroShip.get$Turret()._row;
          t5 = new S.Pos(null, null);
          t5._col = J.$add$ns(this._game._heroShip.get$Turret()._col, 1);
          t5._row = t4;
          t5 = new S.HeroProjectile(0, null, t3, t1, t5, false);
          t5._speed = $.SpeedHeroP;
          t2.push(t5);
          t5 = this._game;
          t2 = $.HeroDMG;
          t1 = t5._heroShip.get$Turret()._row;
          t3 = new S.Pos(null, null);
          t3._col = J.$sub$n(this._game._heroShip.get$Turret()._col, 1);
          t3._row = t1;
          t3 = new S.HeroProjectile(0, null, t2, t5, t3, false);
          t3._speed = $.SpeedHeroP;
          t5._heroP.push(t3);
        }
      }
    },
    MoreDmgPowerUp: {
      "^": "PowerUp;_kind,_speedCounter,_speed,dmg,_game,_anchor,_hit",
      doPowerUpStuff$0: function() {
        $.HeroDMG = J.$add$ns($.HeroDMG, $.HeroDMGIncrease);
    ...
    TripleShot: {
      ...
      doPowerUpStuff$0: function() {
        ...
        if (t3 < t4) {
          ...
          t1 = t5._heroShip.get$Turret()._row;
          t3 = new S.Pos(null, null);
          t3._col = this._game._heroShip.get$Turret()._col;
          t3._row = t1;
          t3 = new S.HeroProjectile(0, null, t2, t5, t3, false);
          t3._speed = $.SpeedHeroP;
          t5._heroP.push(t3);
          t3 = this._game;
          t5 = $.HeroDMG;
          t2 = t3._heroShip.get$Turret()._row;
          t1 = new S.Pos(null, null);
          t1._col = J.$sub$n(this._game._heroShip.get$Turret()._col, 1);
          t1._row = t2;
          t1 = new S.HeroProjectile(0, null, t5, t3, t1, false);
          t1._speed = $.SpeedHeroP;
          t3._heroP.push(t1);
        }
      }
    },
    HomeingMissile: {
      ...
      doPowerUpStuff$0: function() {
        ...
        t1 = this._game;
        t2 = t1._heroP;
        if (t2.length < $.MaxMissiles) {
          t3 = $.MissileDmg;
          t4 = t1._heroShip.get$Turret()._row;
          t5 = new S.Pos(null, null);
          t5._col = this._game._heroShip.get$Turret()._col;
          t5._row = t4;
          t5 = new S.Missile(null, 0, null, t3, t1, t5, false);
          t5._speed = $.SpeedHeroP;
          t2.push(t5);
        }
      }
    ...
    Enemy: {
      ...
      hit$0: function() {
        C.JSArray_methods.forEach$1(this._game._heroP, new S.Enemy_hit_closure());
      },
      Enemy$2: function(game, anchor) {
        this._game = game;
        this._anchor = anchor;
        this._body.push(anchor);
      }
    },
    Enemy_hit_closure: {
      "^": "Closure:0;",
    ...
    MotherShip: {
      "^": "Enemy;_speedCounter,_moveCounter,_moveRight,_dmg,HP,_anchor,_game,_speed,_body",
      move$0: function() {
        var t1, t2, switchMove, _i, t3, posi;
        t1 = ++this._speedCounter;
        t2 = this._speed;
        if (typeof t2 !== "number")
          return H.iae(t2);
        if (t1 > t2) {
          this._speedCounter = 0;
          if (this._moveCounter < 6) {
            for (t1 = this._body, t2 = t1.length, switchMove = false, _i = 0; t3 = t1.length, _i < t3; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
              posi = t1[_i];
              if (J.$eq$(posi._col, 0))
                switchMove = true;
              if (J.$eq$(posi._col, J.$sub$n(this._game._col, 1)))
                switchMove = true;
            }
            if (switchMove)
              this._moveRight = !this._moveRight;
            if (this._moveRight)
              for (_i = 0; _i < t1.length; t1.length === t3 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
                posi = t1[_i];
                posi.setCol$1(J.$add$ns(posi._col, 1));
              }
            else
              for (_i = 0; _i < t1.length; t1.length === t3 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
                posi = t1[_i];
                posi.setCol$1(J.$sub$n(posi._col, 1));
              }
            ++this._moveCounter;
          } else {
            for (t1 = this._body, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
              posi = t1[_i];
              posi.setRow$1(J.$add$ns(posi._row, 1));
            }
            this._moveCounter = 0;
          }
          this.hit$0();
      ...
      shoot$0: function() {
        var t1, t2, t3;
        t1 = this._game;
        t2 = J.$add$ns(this._anchor._row, 1);
        t3 = new S.Pos(null, null);
        t3._col = this._anchor._col;
        t3._row = t2;
        t3 = new S.EnemyProjectile(0, null, this._dmg, t1, t3, false);
        t3._speed = $.SpeedEnemyP;
        t1._enemyP.push(t3);
      },
      damage$1: function(dmg) {
        var t1, t2, t3;
        if (J.$gt$n(this.HP, 0)) {
          t1 = J.$sub$n(this.HP, dmg);
          this.HP = t1;
          if (J.$le$n(t1, 0)) {
            t1 = this._game;
            t2 = t1._punkte;
            ...
            if (typeof t3 !== "number")
              return H.iae(t3);
            t1._punkte = t2 + t3;
            t3 = J.$add$ns(this._anchor._row, 1);
            t2 = new S.Pos(null, null);
            t2._col = this._anchor._col;
            t2._row = t3;
            t1.spawnPowerUp$2(t2, null);
          }
        }
      },
      MotherShip$2: function(game, anchor) {
        var t1, t2, t3, t4;
        ...
        t3 = t2._row;
        t4 = new S.Pos(null, null);
        t4._col = J.$add$ns(t2._col, 1);
        t4._row = t3;
        t1.push(t4);
        t4 = this._anchor;
        t3 = t4._row;
        t2 = new S.Pos(null, null);
        t2._col = J.$sub$n(t4._col, 1);
        t2._row = t3;
        t1.push(t2);
        t2 = J.$sub$n(this._anchor._row, 1);
        t3 = new S.Pos(null, null);
        t3._col = this._anchor._col;
        t3._row = t2;
        t1.push(t3);
        t3 = J.$sub$n(this._anchor._row, 1);
        t2 = new S.Pos(null, null);
        t2._col = J.$add$ns(this._anchor._col, 1);
        t2._row = t3;
        t1.push(t2);
        t2 = J.$sub$n(this._anchor._row, 1);
        t3 = new S.Pos(null, null);
        t3._col = J.$sub$n(this._anchor._col, 1);
        t3._row = t2;
        t1.push(t3);
        this._speed = $.MotherShipSpeed;
      },
      static: {
        MotherShip$: function(game, anchor) {
          var t1 = new S.MotherShip(0, 0, true, $.MotherShipDmg, null, null, null, null, []);
          t1.Enemy$2(game, anchor);
          t1.MotherShip$2(game, anchor);
          return t1;
        }
      }
    },
    Peon: {
      "^": "Enemy;moveRight,_moveCounter,_speedCounter,_dmg,HP,_anchor,_game,_speed,_body",
      move$0: function() {
        var t1, t2;
        t1 = ++this._speedCounter;
        t2 = this._speed;
      ...
      lowest$0: function() {
        var t1 = {};
        t1._lowest = true;
        C.JSArray_methods.forEach$1(this._game._enemies, new S.Peon_lowest_closure(t1, this));
        return t1._lowest;
      },
      shoot$0: function() {
        var t1, t2, t3;
      ...
      Peon$2: function(game, position) {
        this.HP = $.PeonHp;
        this._speed = $.PeonSpeed;
      },
      static: {
        Peon$: function(game, position) {
          var t1 = new S.Peon(true, 0, 0, $.PeonDmg, null, null, null, null, []);
          t1.Enemy$2(game, position);
          t1.Peon$2(game, position);
          return t1;
        }
      }
    },
    Peon_lowest_closure: {
      ...
      call$1: function(e) {
        var t1;
        if (e instanceof S.Peon) {
          t1 = this.$this;
          t1 = J.$eq$(e._anchor._col, t1._anchor._col) && J.$gt$n(e._anchor._row, t1._anchor._row);
        } else
          t1 = false;
        if (t1)
          this._box_0._lowest = false;
      }
    },
    SpacePeonsView: {
      "^": "Object;_gui,_table,_fadeCounter,_hero,_hero_doubleShot,_schuss,_schussEnemy,_enemy1,_mothership,_hpUp,_barrier,_moreShot,_extraPoints,_barricade,_missile,_moreDmg",
      buildField$2: function(col, rows) {
        var t1, tBody2, t2, t3, row, i, t4;
        t1 = document.querySelector("#button_container").style;
        t1.display = "none";
        t1 = document.querySelector("#title").style;
        t1.display = "none";
        t1 = this._gui.style;
        t1.visibility = "visible";
        J._clearChildren$0$x(J.get$children$x(this._table)._html$_element);
        tBody2 = J.createTBody$0$x(this._table);
        t1 = J.getInterceptor$ns(rows);
        t2 = J.getInterceptor$ns(col);
        t3 = J.getInterceptor$x(tBody2);
        row = null;
        i = 0;
        while (true) {
          t4 = J.$mul$ns(t1.$add(rows, 1), col);
          if (typeof t4 !== "number")
            return H.iae(t4);
          if (!(i < t4))
            break;
          ...
          if (C.JSInt_methods.$mod(i, t4) === 0)
            row = t3.addRow$0(tBody2);
          else
            J.addCell$0$x(row);
          ++i;
        }
        this._table = H.setRuntimeTypeInfo(new W._FrozenElementList(document.querySelectorAll("td")), [null]);
      },
      updateView$2: function(field, guidaten) {
        var t1, i, _i, t2;
        J.set$innerHtml$x(this._gui, C.JSString_methods.$add(C.JSString_methods.$add(C.JSString_methods.$add(C.JSString_methods.$add(C.JSString_methods.$add("<br><br>Level:<br>", J.toString$0$(guidaten[0])) + " ", guidaten[1]) + "<br><br>Punkte:<br>", J.toString$0$(guidaten[2])) + "<br><br>Leben:<br>", J.toString$0$(guidaten[3])) + "<br><br>Schaden:<br>", J.toString$0$(guidaten[4])));
        for (t1 = field.length, i = 0, _i = 0; _i < field.length; field.length === t1 || (0, H.throwConcurrentModificationError)(field), ++_i) {
          switch (field[_i]) {
            case 0:
              t2 = J.get$style$x(J.$index$asx(this._table, i));
              t2.backgroundColor = "transparent";
              J.clear$0$ax(J.get$children$x(J.$index$asx(this._table, i)));
              break;
            case 1:
              if (J.get$isEmpty$asx(J.get$children$x(J.$index$asx(this._table, i))))
                J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._schuss.cloneNode(true));
              break;
            case 2:
              if (J.get$isEmpty$asx(J.get$children$x(J.$index$asx(this._table, i))))
                J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._schussEnemy.cloneNode(true));
              break;
            case 3:
              break;
            case 4:
              J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._mothership.cloneNode(true));
              break;
            case 5:
              if (J.get$isEmpty$asx(J.get$children$x(J.$index$asx(this._table, i))))
                J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._hero.cloneNode(true));
              break;
            case 6:
              J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._enemy1.cloneNode(true));
              break;
            case 7:
              J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._extraPoints.cloneNode(true));
              break;
            case 8:
              J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._moreShot.cloneNode(true));
              break;
            case 9:
              J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._hpUp.cloneNode(true));
              break;
            case 10:
              J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._barrier.cloneNode(true));
              break;
            case 11:
              if (J.get$isEmpty$asx(J.get$children$x(J.$index$asx(this._table, i))))
                J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._barricade.cloneNode(true));
              break;
            case 12:
              if (J.get$isEmpty$asx(J.get$children$x(J.$index$asx(this._table, i))))
                J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._hero_doubleShot.cloneNode(true));
              break;
            case 13:
              if (J.get$isEmpty$asx(J.get$children$x(J.$index$asx(this._table, i))))
                J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._missile.cloneNode(true));
              break;
            case 14:
              if (J.get$isEmpty$asx(J.get$children$x(J.$index$asx(this._table, i))))
                J.add$1$ax(J.get$children$x(J.$index$asx(this._table, i)), this._moreDmg.cloneNode(true));
              break;
          }
          ++i;
        }
      },
      showHighscore$1: function(highscore) {
        var t1, list;
        t1 = document.querySelector("#button_container").style;
        t1.display = "none";
        t1 = document.querySelector("#title").style;
        ...
        t1 = document.querySelector("#cancelHighscore").style;
        t1.display = "block";
        list = J.map$1$ax(highscore, new S.SpacePeonsView_showHighscore_closure()).join$1(0, "");
        J.set$innerHtml$x(document.querySelector("#highscore"), list);
      },
      fadeInStart$1: [function(e) {
        var t1, t2;
        t1 = document.querySelector("#title").style;
        t2 = C.JSInt_methods.toString$0(this._fadeCounter) + "px";
        t1.marginTop = t2;
        t1 = document.querySelector("#button_container").style;
        t2 = C.JSInt_methods.toString$0(420 - this._fadeCounter) + "px";
        t1.marginTop = t2;
        t1 = this._fadeCounter += 5;
        if (t1 > 130) {
          J.cancel$0$x(e);
          this._fadeCounter = -100;
        }
      }, "call$1", "get$fadeInStart", 2, 0, 29],
      SpacePeonsView$0: function() {
        var t1, t2;
        this._fadeCounter = -100;
        this._table = H.interceptedTypeCast(document.querySelector("table"), "$isTableElement");
        this._gui = document.querySelector("#gui");
        t1 = W.ImageElement_ImageElement(null, "../pictures/schuss.png", null);
        this._schuss = t1;
        t1 = t1.style;
        t1.height = "16px";
        t1 = W.ImageElement_ImageElement(null, "../pictures/schussEnemy.png", null);
        this._schussEnemy = t1;
        t1 = t1.style;
        t1.height = "16px";
        t1 = W.ImageElement_ImageElement(null, "../pictures/mothership.png", null);
        this._mothership = t1;
        t2 = t1.style;
        t2.width = "48px";
        t1 = t1.style;
        t1.height = "32px";
        t1 = W.ImageElement_ImageElement(null, "../pictures/peon.png", null);
        this._enemy1 = t1;
        t1 = t1.style;
        t1.width = "16px";
        t1 = W.ImageElement_ImageElement(null, "../pictures/hpUp.png", null);
        this._hpUp = t1;
        t1 = t1.style;
        t1.width = "16px";
        t1 = W.ImageElement_ImageElement(null, "../pictures/shield.png", null);
        this._barrier = t1;
        t1 = t1.style;
        t1.width = "16px";
        t1 = W.ImageElement_ImageElement(null, "../pictures/laser-blast.png", null);
        this._moreShot = t1;
        t1 = t1.style;
        t1.width = "16px";
        t1 = W.ImageElement_ImageElement(null, "../pictures/diamond.png", null);
        this._extraPoints = t1;
        t1 = t1.style;
        t1.width = "16px";
        t1 = W.ImageElement_ImageElement(null, "../pictures/player.png", null);
        this._hero = t1;
        t2 = t1.style;
        t2.width = "48px";
        t1 = t1.style;
        t1.height = "32px";
        t1 = W.ImageElement_ImageElement(null, "../pictures/player_doubleShot.png", null);
        this._hero_doubleShot = t1;
        t2 = t1.style;
        t2.width = "48px";
        t1 = t1.style;
        t1.height = "32px";
        t1 = W.ImageElement_ImageElement(null, "../pictures/whiteblock.png", null);
        this._barricade = t1;
        t1 = t1.style;
        t1.height = "16px";
        t1 = W.ImageElement_ImageElement(null, "../pictures/missile.png", null);
        this._missile = t1;
        t1 = t1.style;
        t1.width = "16px";
        t1 = W.ImageElement_ImageElement(null, "../pictures/moreDmg.png", null);
        this._moreDmg = t1;
        t1 = t1.style;
        t1.width = "16px";
      },
      static: {
        SpacePeonsView$: function() {
          var t1 = new S.SpacePeonsView(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
          t1.SpacePeonsView$0();
          return t1;
        }
      }
    },
    SpacePeonsView_showHighscore_closure: {
      "^": "Closure:0;",
      call$1: function(entry) {
        var t1 = J.getInterceptor$asx(entry);
        return H.S(t1.$index(entry, "name")) + ": " + H.S(t1.$index(entry, "score")) + " <br>";
      }
    }
  }], ["", "spacepeonsClient.dart",, S, {
    "^": "",
    main: [function() {
      var t1, t2;
      t1 = new S.SpacePeonsController(null, null, null, null);
      t2 = J.get$onClick$x(document.querySelector("#start"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$startGame()), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(document.querySelector("#playmode"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$changePlaymode()), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(document.querySelector("#difficulty"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$changeDifficult()), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(document.querySelector("#highscorebutton"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$showHighscore()), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(document.querySelector("#confirm"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$setHighscore()), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(document.querySelector("#cancelGameOver"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$reloadWindow()), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.get$onClick$x(document.querySelector("#cancelHighscore"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(t1.get$reloadWindow()), false), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1._ignoreInput = false;
      t1._view = S.SpacePeonsView$();
      t1._game = new S.SpacePeonsGame(20, 3, 0, 0, C.C__JSRandom, false, 0, 0, null, H.setRuntimeTypeInfo([], [S.Barrier]), H.setRuntimeTypeInfo([], [S.Barrier]), null, H.setRuntimeTypeInfo([], [S.HeroProjectile]), H.setRuntimeTypeInfo([], [S.Enemy]), H.setRuntimeTypeInfo([], [S.EnemyProjectile]), H.setRuntimeTypeInfo([], [S.Enemy]), H.setRuntimeTypeInfo([], [S.PowerUp]), [], [], 40, 40, null, null);
      t1.initGameKey$1("gamekey.json");
      P.Timer_Timer$periodic(C.Duration_20000, t1._view.get$fadeInStart());
      return t1;
    }, "call$0", "spacepeonsClient__main$closure", 0, 0, 1]
  }, 1]];
  setupProgram(dart, 0);
...
;
  ...
  C.Map_O9Feh = new H.GeneralConstantMap([0, "PowerUpKind.Once", 1, "PowerUpKind.Weapon"]);
  C.PowerUpKind_0 = new S.PowerUpKind(0);
  C.PowerUpKind_1 = new S.PowerUpKind(1);
  C.Symbol_gameOver = new H.Symbol("gameOver");
  C.Symbol_gameWon = new H.Symbol("gameWon");
  C.Symbol_levelWon = new H.Symbol("levelWon");
  C.Symbol_notRunning = new H.Symbol("notRunning");
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [W.Event]}, {func: 1, ret: W.Node}, {func: 1, args: [W.Event]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.String, P.String]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, args: [W.HttpRequest]}, {func: 1, v: true, args: [W.Node, W.Node]}, {func: 1, args: [P.Timer]}, {func: 1, v: true, args: [W.KeyboardEvent]}, {func: 1, ret: P.Future, args: [,]}, {func: 1, v: true, args: [P.Timer]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(S.spacepeonsClient__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(S.spacepeonsClient__main$closure(), a);
...
//# sourceMappingURL=spacepeonsClient.dart.js.map
