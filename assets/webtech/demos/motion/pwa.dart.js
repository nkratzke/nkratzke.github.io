...
z.b=$.$get$es()
P.bx("Running PWA, version: 2018-05-17T16:53:38.000Z")
X.jX(z)},"$0","ev",0,0,2]},1]]
setupProgram(dart,0)
...
y.d6(null,z)
return y},"b9","$get$b9",function(){return[]},"es","$get$es",function(){return["./","./background.png","./danger.png","./item.png","./main.dart.js","./manifest.json","./packages/browser/dart.js","./packages/browser/interop.js","./packages/front_end/src/fasta/TESTING.md","./packages/front_end/src/fasta/diagnostics.md","./packages/kernel/analyzer/readme.md","./packages/kernel/binary/readme.md","./packages/kernel/frontend/readme.md","./packages/kernel/target/readme.md","./packages/kernel/text/readme.md","./qr.png","./styles.css","./warning.png"]},"e4","$get$e4",function(){return["https://fonts.google.com/","https://fonts.googleapis.com/","https://fonts.gstatic.com/"]},"dx","$get$dx",function(){return new L.i3(self.self,null,null,null,null,null,null,null,null,null,null,null)},"Q","$get$Q",function(){return $.$get$dx()}])
