...
var iom = iom || (function () {
  ...
  function loadSurvey() {
    ...
    if (sv && !surveyCalled && result.sv !== "ke" && result.sv !== "dz" && (result.sv === "in" || result.sv === "mo" || result.sv === "i2" )) {
      surveyCalled = 1;
      var loaded = 0;
      ...
      if (loaded==0 && result.sv === "in") document.write("<scr"+"ipt src='"+window.location.protocol+"//qs.ioam.de/?"+((window.szmvars)?szmvars:"")+"'></scr"+"ipt>");
  ...
  function transmitData(url, mode) {
    if (url.split("/")[2].slice(url.split("/")[2].length-8) == ".ioam.de") {
      switch (mode) {
        ...
        case 0:
        default:
          document.write('<sc'+'ript src="'+url+'&mo=1"></sc'+'ript>');
      }
    }
  }
