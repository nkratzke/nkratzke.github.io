...
"%":"DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList|SVGPointList"},
kn:{
"^":"bool/Gv;",
...
q.h(0,0)
o.aU(0,p)
init.globalState.Xz.Rk.NZ(new H.t8(o,new H.jl(w,v,u,t,s),"worker-start"))
...
if(b==null)return!1
z=J.x(b)
return typeof b==="object"&&b!==null&&!!z.$iswv&&J.de(this.fN,b.fN)},
...
$.X3=a
return z},
Qh:function(a,b,c,d,e){P.T8(a,null,a,new P.pK(d,e))},
...
if((b.Xl===2?null:b.o4)!=null)new P.RT(z,x,w,b,t).call$0()
if(s!=null)$.X3=s
if(x.d)return
y=x.b===!0
if(y){u=x.c
...
if(z<this.tD){this.Cf=this.zo(z)
this.KK=this.KK+1
...
return}throw "Unable to print message: " + String(a)}}],["dartsnake","package:snakedart/dartsnake.dart",,E,{
"^":"",
IY:{
"^":"a;Vt,Wr,bj,zY",
M8:function(){var z=this.Vt
...
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new E.Kv(this)),z.Sg),[H.Kp(z,0)]).Zz()},
static:{uj:function(){var z=new E.IY(E.UN(30),new E.Zw(document.querySelector("#title"),document.querySelector("#welcome"),document.querySelector("#snakegame"),document.querySelector("#gameover"),document.querySelector("#reasons"),document.querySelector("#points")),null,null)
z.T7()
return z}}},
SB:{
"^":"Tp:8;a",
...
x=z.Wr
x.ul(y)
z.bj=P.SZ(C.Xl,new E.pa(z))
z.zY=P.SZ(C.vM,new E.yJ(z))
z=z.Vt
z.Um=C.L2
x.eC(z)}},
pa:{
"^":"Tp:8;b",
call$1:function(a){return this.b.OT()}},
yJ:{
"^":"Tp:8;c",
call$1:function(a){return this.c.M8()}},
Kv:{
"^":"Tp:20;d",
call$1:function(a){var z=this.d
if(J.de(z.Vt.Um,C.Ks))return
switch(J.Zm(a)){case 37:z=z.Vt.EG
z.JF=0
z.m9=-1
break
case 39:z=z.Vt.EG
...
z=J.WB(C.Nm.gtH(this.fo).t(0,"row"),this.JF)
y=J.WB(C.Nm.gtH(this.fo).t(0,"col"),this.m9)
x=this.Ir
w=x.Jb
v=H.VM(new H.U5(w,new E.uU(z,y)),[null])
u=this.fo
t=H.B7(["row",z,"col",y],P.L5(null,null,null,null,null))
u.splice(0,0,t)
if(!v.gA(v).G()){x=this.fo
C.Nm.Rz(x,C.Nm.grZ(x))}else{if(0>=w.length)H.vh(P.N(0))
w.splice(0,1)[0]
if(J.de(x.Um,C.L2))x.yD=x.yD+1
x.kt()}},
guF:function(){return H.VM(new H.A8(this.fo,new E.yI()),[null,null]).zH(0).X5!==this.fo.length},
gWa:function(){if(J.J5(C.Nm.gtH(this.fo).t(0,"row"),0)){var z=this.Ir.ca
z=J.u6(C.Nm.gtH(this.fo).t(0,"row"),z)&&J.J5(C.Nm.gtH(this.fo).t(0,"col"),0)&&J.u6(C.Nm.gtH(this.fo).t(0,"col"),z)}else z=!1
return z},
gB:function(a){return this.fo.length},
R7:function(a){var z=this.Ir.ca/2|0
this.fo=[H.B7(["row",z,"col",z],P.L5(null,null,null,null,null)),H.B7(["row",z+1,"col",z],P.L5(null,null,null,null,null))]
this.JF=-1
this.m9=0}},
uU:{
"^":"Tp:8;a,b",
call$1:function(a){return a.geH()===this.a&&a.xJ===this.b}},
yI:{
"^":"Tp:8;",
call$1:function(a){var z=J.U6(a)
return H.d(z.t(a,"row"))+","+H.d(z.t(a,"col"))}},
iX:{
"^":"a;Ir,pS,xJ,JF,m9",
geH:function(){return this.pS},
h7:function(){var z,y
z=this.JF
if(z<0&&this.pS===0){z*=-1
this.JF=z}y=this.m9
if(y<0&&this.xJ===0){y*=-1
this.m9=y}if(z>0&&this.pS===this.Ir.ca-1){z*=-1
this.JF=z}if(y>0&&this.xJ===this.Ir.ca-1){z*=-1
this.JF=z}this.pS=this.pS+z
this.xJ=this.xJ+y}},
Ky:{
"^":"a;EG,Jb,ca,Um,yD",
gt0:function(){var z,y
z=H.VM(new P.Rt(this.ca,new E.H6(this)),[null])
y=P.F(z,!0,H.ip(z,"mW",0))
H.bQ(this.Jb,new E.PR(y))
H.bQ(this.EG.fo,new E.JP(this,y))
return y},
wf:function(){if(J.de(this.Um,C.L2))H.bQ(this.Jb,new E.Xh())},
kt:function(){if(J.de(this.Um,C.Ks))return
var z=this.ca
z=new E.iX(this,C.pr.j1(z),C.pr.j1(z),null,null)
z.JF=0
z.m9=0
this.Jb.push(z)},
bu:function(a){return H.VM(new H.A8(this.gt0(),new E.IW()),[null,null]).zV(0,"\n")},
Eg:function(a){var z
this.Um=C.L2
z=new E.zG(this,[],null,null)
z.R7(this)
this.EG=z
this.kt()
this.Um=C.Ks},
static:{UN:function(a){var z=new E.Ky(null,[],a,null,0)
z.Eg(a)
return z}}},
H6:{
"^":"Tp:8;a",
call$1:function(a){var z=H.VM(new P.Rt(this.a.ca,new E.ah()),[null])
return P.F(z,!0,H.ip(z,"mW",0))}},
ah:{
"^":"Tp:8;",
call$1:function(a){return C.VN}},
PR:{
"^":"Tp:8;b",
call$1:function(a){var z,y
z=this.b
...
x=z.t(a,"col")
z=J.Wx(y)
if(z.C(y,0)||z.F(y,this.c.ca))return
z=J.Wx(x)
if(z.C(x,0)||z.F(x,this.c.ca))return
z=this.d
if(y>>>0!==y||y>=z.length)return H.e(z,y)
J.kW(z[y],x,C.X9)}},
Xh:{
"^":"Tp:8;",
call$1:function(a){return a.h7()}},
IW:{
"^":"Tp:8;",
call$1:function(a){return J.XS(a," ")}},
Zw:{
"^":"a;mk,iO,Vt,Tr,DZ,cB",
eC:function(a){var z,y,x,w,v,u,t
z=this.iO.style
J.oH(z,J.de(a.Um,C.Ks)?"block":"none")
J.Qy(this.cB,"Points: "+a.yD)
z=!a.EG.gWa()||a.EG.guF()?"Game Over":""
J.Qy(this.Tr,z)
z=this.DZ
y=J.RE(z)
y.shf(z,"")
if(!a.EG.gWa()||a.EG.guF()){x=a.EG.guF()?"Do not tangle your snake<br>":""
y.shf(z,x+(!a.EG.gWa()?"Keep your snake on the field<br>":""))}w=a.gt0()
for(z=this.Vt,v=0;v<w.length;++v){u=0
while(!0){if(v>=w.length)return H.e(w,v)
y=J.q8(w[v])
if(typeof y!=="number")return H.s(y)
if(!(u<y))break
t=z.querySelector("#field_"+v+"_"+u)
if(t!=null){y=J.RE(t)
y.gDD(t).V1(0)
if(v>=w.length)return H.e(w,v)
if(J.de(J.UQ(w[v],u),C.c2))y.gDD(t).h(0,"mouse")
else{if(v>=w.length)return H.e(w,v)
if(J.de(J.UQ(w[v],u),C.X9))y.gDD(t).h(0,"snake")
else{if(v>=w.length)return H.e(w,v)
if(J.de(J.UQ(w[v],u),C.VN))y.gDD(t).h(0,"empty")}}}++u}}},
...
u=J.UQ(z[x],w)
y+="<td id='"+("field_"+x+"_"+w)+"' class='"+H.d(u)+"'></td>";++w}y+="</tr>"}J.Qy(this.Vt,y)}}}],["html_common","dart:html_common",,P,{
"^":"",
As:{
"^":"a;",
...
a.vv=null
a.X5=0
a.zN=a.zN+1&67108863}return}}}],["","file:///Users/nane/github/dartsnake/web/snakeclient.dart",,V,{
"^":"",
Iq:[function(){return E.uj()},"call$0","eE",0,0,6]},1],])
...
C.VN=new H.wv("empty")
C.c2=new H.wv("mouse")
C.L2=new H.wv("running")
C.X9=new H.wv("snake")
C.Ks=new H.wv("stopped")
C.vB=J.is.prototype
C.ol=W.Oi.prototype
$.libraries_to_load = {}
$.te="$cachedFunction"
...
init.metadata=[{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"Vv",ret:J.kn,args:[W.cv,J.O,J.O,W.JQ]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"KV",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.GD,null]},{func:"Cu",ret:J.O,args:[J.im]},{func:"YI",void:true,args:[P.a]},{func:"qu",void:true,args:[W.KV]},{func:"c0",args:[W.HL]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
GV.prototype=$desc
function IY(Vt,Wr,bj,zY){this.Vt=Vt
this.Wr=Wr
this.bj=bj
this.zY=zY}IY.builtin$cls="IY"
if(!"name" in IY)IY.name="IY"
$desc=$collectedClasses.IY
if($desc instanceof Array)$desc=$desc[1]
IY.prototype=$desc
function SB(a){this.a=a}SB.builtin$cls="SB"
if(!"name" in SB)SB.name="SB"
$desc=$collectedClasses.SB
if($desc instanceof Array)$desc=$desc[1]
SB.prototype=$desc
function pa(b){this.b=b}pa.builtin$cls="pa"
if(!"name" in pa)pa.name="pa"
$desc=$collectedClasses.pa
if($desc instanceof Array)$desc=$desc[1]
pa.prototype=$desc
function yJ(c){this.c=c}yJ.builtin$cls="yJ"
if(!"name" in yJ)yJ.name="yJ"
$desc=$collectedClasses.yJ
if($desc instanceof Array)$desc=$desc[1]
yJ.prototype=$desc
function Kv(d){this.d=d}Kv.builtin$cls="Kv"
if(!"name" in Kv)Kv.name="Kv"
$desc=$collectedClasses.Kv
if($desc instanceof Array)$desc=$desc[1]
Kv.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
rk.prototype=$desc
function zG(Ir,fo,JF,m9){this.Ir=Ir
this.fo=fo
this.JF=JF
...
if($desc instanceof Array)$desc=$desc[1]
zG.prototype=$desc
function uU(a,b){this.a=a
this.b=b}uU.builtin$cls="uU"
...
if($desc instanceof Array)$desc=$desc[1]
yI.prototype=$desc
function iX(Ir,pS,xJ,JF,m9){this.Ir=Ir
this.pS=pS
this.xJ=xJ
this.JF=JF
this.m9=m9}iX.builtin$cls="iX"
if(!"name" in iX)iX.name="iX"
$desc=$collectedClasses.iX
if($desc instanceof Array)$desc=$desc[1]
iX.prototype=$desc
function Ky(EG,Jb,ca,Um,yD){this.EG=EG
this.Jb=Jb
this.ca=ca
this.Um=Um
this.yD=yD}Ky.builtin$cls="Ky"
if(!"name" in Ky)Ky.name="Ky"
$desc=$collectedClasses.Ky
if($desc instanceof Array)$desc=$desc[1]
Ky.prototype=$desc
function H6(a){this.a=a}H6.builtin$cls="H6"
...
if($desc instanceof Array)$desc=$desc[1]
ah.prototype=$desc
function PR(b){this.b=b}PR.builtin$cls="PR"
if(!"name" in PR)PR.name="PR"
$desc=$collectedClasses.PR
if($desc instanceof Array)$desc=$desc[1]
PR.prototype=$desc
function JP(c,d){this.c=c
...
if($desc instanceof Array)$desc=$desc[1]
IW.prototype=$desc
function Zw(mk,iO,Vt,Tr,DZ,cB){this.mk=mk
this.iO=iO
this.Vt=Vt
this.Tr=Tr
this.DZ=DZ
this.cB=cB}Zw.builtin$cls="Zw"
...
if($desc instanceof Array)$desc=$desc[1]
uQ.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,P2,nB,i3,it,QP,IF,n6,Ny,nx,QQ,fW,y4,d7,Um,oJ,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,ae,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,In,wP,eP,A6,Og,u8,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,xe,Pg,bn,Ik,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,FH,SN,HD,f5,rR,qj,nC,KR,ew,fs,u2,bX,lr,MC,iQ,qI,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,fA,Oi,UM,hq,WS,NL,yp,c1,Mq,Nf,Nc,Mx,rh,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,um,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,ED,Gq,GH,To,jr,j2,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,Kf,MT,Rk,Eo,YS,ox,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,t8,JH,jl,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,DH,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,aL,a7,i1,xy,MH,A8,U5,SO,SU,wv,Ca,vs,da,xw,dm,rq,RW,RT,jZ,FZ,OM,qh,dW,QC,Lp,lz,Rl,Jb,M4,B5,PI,MO,nP,v1,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,Rt,l7,An,c8,a,mE,Rn,GD,M0,BV,id,Cv,e7,zL,ec,dx,kE,tJ,i7,I4,Fk,RO,eu,xC,JQ,Pb,vD,mD,Eg,m6,ct,tE,Ow,W9,rB,kF,mk,MM,fm,O7,IU,mg,b0,CB,Ob,GV,IY,SB,pa,yJ,Kv,rk,zG,uU,yI,iX,Ky,H6,ah,PR,JP,Xh,IW,Zw,As,GE,uQ]}