...
["ML_Web_Erathosthenes", "package:ML_Web_Erathosthenes/ML_Web_Erathosthenes.dart", , R, {
  "^": "",
  prims: function(n) {
    var ret, gestrichen, t1, i, j, t2;
    ret = [];
    gestrichen = P.Iterable_Iterable$generate(J.$add$ns(n, 1), new R.prims_closure(), null).toList$0(0);
    t1 = typeof n !== "number";
    i = 2;
    while (true) {
      if (t1)
        H.throwExpression(P.ArgumentError$(n));
      if (!(i <= Math.sqrt(n)))
        break;
      if (i >= gestrichen.length)
        return H.ioore(gestrichen, i);
      if (gestrichen[i] !== true) {
        ret.push(i);
        j = i * i;
        if (typeof n !== "number")
          return H.iae(n);
        t2 = gestrichen.length;
        for (; j <= n; j += i) {
          if (j >= t2)
            return H.ioore(gestrichen, j);
          gestrichen[j] = true;
        }
      }
      ++i;
    }
    i = C.JSNumber_methods.toInt$0(Math.floor(Math.sqrt(H.checkNum(n)))) + 1;
    if (typeof n !== "number")
      return H.iae(n);
    for (; i <= n; ++i) {
      if (i < 0 || i >= gestrichen.length)
        return H.ioore(gestrichen, i);
      if (gestrichen[i] !== true)
        ret.push(i);
    }
  ...
  toHtmlTable: function(ns, cols, c) {
    var tab, t1, receiverLength;
    for (tab = "\n"; ns.length !== 0;) {
      t1 = new H.IterableMixinWorkaround();
      t1.$builtinTypeInfo = [H.getTypeArgumentByIndex(ns, 0)];
      t1 = new H.MappedListIterable(H.SubListIterable$(ns, 0, cols, H.getTypeArgumentByIndex(t1, 0)), new R.toHtmlTable_closure());
      t1.$builtinTypeInfo = [null, null];
      tab += "<tr>" + H.S(t1.join$0(0)) + "</tr>\n";
      t1 = P.min(cols, ns.length);
      receiverLength = ns.length;
      if (t1 > receiverLength)
        H.throwExpression(P.RangeError$range(t1, 0, receiverLength, null, null));
      H.Lists_copy(ns, t1, ns, 0, receiverLength - t1);
      C.JSArray_methods.set$length(ns, receiverLength - (t1 - 0));
    }
  ...
  prims_closure: {
    ...
    call$1: function(i) {
      ...
      return (t1.$eq(i, 0) || t1.$eq(i, 1)) && true;
    }
  },
  toHtmlTable_closure: {
    "^": "Closure:10;",
...
["", "client.dart", , U, {
  "^": "",
  main: [function() {
    var t1, error_div, prims_div, input, t2;
    t1 = {};
    error_div = document.querySelector("#error");
    prims_div = document.querySelector("#prims");
    input = document.querySelector("#n");
    J.set$innerHtml$x(prims_div, "<em>Und hier k\u00f6nnten Ihre Primzahlen stehen ...</em>");
    t1.n_0 = 0;
    t2 = J.get$onInput$x(input);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.main_closure(t1, 100000, error_div, prims_div)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
  ...
  main__closure: {
    "^": "Closure:10;error_div_4,prims_div_5",
    call$1: function(s) {
      J.set$innerHtml$x(this.error_div_4, "Bitte geben Sie eine positive ganze Zahl > 0 ein!");
      J.set$innerHtml$x(this.prims_div_5, "");
      return 0;
    }
  }
},
...
["dart._internal", "dart:_internal", , H, {
  ...
  ListIterable: {
    ...
    join$1: function(_, separator) {
      var $length, first, buffer, i, str, t1;
      $length = this.get$length(this);
...
["dart.core", "dart:core", , P, {
  ...
  "+int": 0,
  _GeneratorIterable: {
    "^": "IterableBase;_start,_end,_generator",
    get$iterator: function(_) {
    ...
    static: {_GeneratorIterable__id: [function(n) {
        return n;
      }, "call$1", "_GeneratorIterable__id$closure", 2, 0, 8]}
  },
  _GeneratorIterator: {
